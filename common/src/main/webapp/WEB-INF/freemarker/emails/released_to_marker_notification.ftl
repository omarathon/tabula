...
<#if assignment.collectSubmissions>
 ...
 - <@fmt.p number=numReleasedSubmissionsFeedbacks!0 singular="student" plural="students" /> <@fmt.p number=numReleasedMSubmissionsFeedbacks!0 singular="has" plural="have" shownumber=false /> submitted work
