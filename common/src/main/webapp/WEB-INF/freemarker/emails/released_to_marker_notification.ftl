...
- <@fmt.p number=numNoSubmissionWithinExtension!0 singular="student" plural="students" /> <@fmt.p number=numReleasedNoSubmissionsFeedbacks!0 singular="has" plural="have" shownumber=false /> not submitted work within extension
- <@fmt.p number=numNoSubmissionWithoutExtension!0 singular="student" plural="students" /> <@fmt.p number=numReleasedNoSubmissionsFeedbacks!0 singular="has" plural="have" shownumber=false /> not submitted work and have not yet requested an extension
  <#else>
