...
- <@fmt.p number=numReleasedSubmissionsFeedbacks!0 singular="student" plural="students" /> <@fmt.p number=numReleasedSubmissionsFeedbacks!0 singular="has" plural="have" shownumber=false /> submitted work that can be marked
- <@fmt.p number=numNoSubmissionWithinExtension!0 singular="student" plural="students" /> <@fmt.p number=numNoSubmissionWithinExtension!0 singular="has" plural="have" shownumber=false /> not submitted but they have an extension
