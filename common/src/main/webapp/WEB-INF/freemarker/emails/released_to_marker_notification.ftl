...
- <@fmt.p number=noSubmissionsWithoutExtensionCount!0 singular="student" plural="students" /> <@fmt.p number=noSubmissionsWithoutExtensionCount!0 singular="has" plural="have" shownumber=false /> not submitted work and have not yet requested an extension
  <#else>
