...
object ScientiaHttpTimetableFetchingService extends Logging {
	...
	private final val CentrallyManagedRooms: Map[String, MapLocation] = Map(
		...
		"ES_A2.06" -> MapLocation("A2.06", "31034"),"ES_F0.24" -> MapLocation("F0.24", "30680"),"ES_F1.04" -> MapLocation("Lobby", "30926"),
		...
		"WM_0.06" -> MapLocation("0.06", "19670"),"WM_1.10" -> MapLocation("IMC1.10", "46052"),"WM_1.09" -> MapLocation("IMC1.09", "46053"),
