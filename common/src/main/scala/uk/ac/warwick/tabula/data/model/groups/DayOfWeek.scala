...
object DayOfWeek {
  ...
  private[groups] def find(i: Int) = members find {
    _.jodaDayOfWeek == i
  }

  def apply(i: Int): DayOfWeek = find(i) getOrElse {
    throw new IllegalArgumentException(s"Invalid value for day of week: $i")
  }
