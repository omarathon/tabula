...
class FeaturesMessage {
	...
	@BeanProperty var schedulingRemoveAgedStudentCourseYearDetailsJob = true
	@BeanProperty var schedulingRemoveAgedModuleRegistrationJob = true
	@BeanProperty var schedulingRemoveAgedStudentCourseDetailsJob = true
