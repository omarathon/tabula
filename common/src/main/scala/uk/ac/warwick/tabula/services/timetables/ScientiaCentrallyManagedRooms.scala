...
object ScientiaCentrallyManagedRooms {
	...
	final val CentrallyManagedRooms: Map[String, MapLocation] = Map(
		...
		"WM_1.06" -> MapLocation("F1.06", "30928", Some("WM_1.06")),
		...
		"MD0.01" -> MapLocation("MD1.01", "20754", Some("MD0.01")),
		...
		"MAS_CONCOURSE" -> MapLocation("D1.01", "30943", Some("MAS_CONCOURSE")),
		"H3.05" -> MapLocation("H3.03", "21584", Some("H3.05")),
		"MAS_2.06" -> MapLocation("2.306", "25512", Some("MAS_2.06")),
		"MAS_2.03" -> MapLocation("H2.03", "21518", Some("MAS_2.03")),
		"MAS_2.04" -> MapLocation("H2.04", "21519", Some("MAS_2.04")),
		"MAS_2.05" -> MapLocation("AS2.05", "33352", Some("MAS_2.05")),
		"H0.01" -> MapLocation("H0.01", "21318", Some("H0.01")),
		"ES_A2.06" -> MapLocation("A2.06", "31034", Some("ES_A2.06")),
		...
		"EP_WT0.01" -> MapLocation("WT0.01", "38973", Some("EP_WT0.01")),
		"WT0.05" -> MapLocation("WT0.05", "38982", Some("WT0.05")),
		"EP_WT0.06 (lc)" -> MapLocation("WT0.06", "38964", Some("EP_WT0.06 (lc)")),
		"WT1.01" -> MapLocation("WT1.01", "38997", Some("WT1.01")),
		"EP_WT1.03 (lab)" -> MapLocation("WT1.03", "38995", Some("EP_WT1.03 (lab)")),
		...
		"EP_WT1.06 (lab)" -> MapLocation("WT1.06", "38993", Some("EP_WT1.06 (lab)")),
		...
		"WLT" -> MapLocation("WT0.02", "38986", Some("WLT")),
		...
		"H0.52" -> MapLocation("H0.51", "21336", Some("H0.52")),
		...
		"IT_H4.03" -> MapLocation("H4.03", "21658", Some("IT_H4.03")),
		"FR_H4.43" -> MapLocation("H4.43", "21643", Some("FR_H4.43")),
		"FR_H4.44" -> MapLocation("H4.44", "21642", Some("FR_H4.44")),
		"CS_CS1.04" -> MapLocation("CS1.04", "26858", Some("CS_CS1.04")),
		"GE_H2.02" -> MapLocation("H2.02", "21517", Some("GE_H2.02")),
		...
		"R1.13" -> MapLocation("Ramphal Building", "41355", Some("R1.13")),
		...
		"R3.25" -> MapLocation("The Gillian Rose Seminar Room", "27762", Some("R3.25")),
		...
		"MS.B3.03" -> MapLocation("B3.03", "29094", Some("MS.B3.03")),
		"S0.50" -> MapLocation("S0.50", "37421", Some("S0.50")),
		"PX_CONCOURSE" -> MapLocation("Chemistry", "51236", Some("PX_CONCOURSE")),
		"FI_A1.25" -> MapLocation("A1.25", "28587", Some("FI_A1.25")),
		"ST_C0.01" -> MapLocation("C0.01", "40876", Some("ST_C0.01")),
		"WM_1.04" -> MapLocation("CS1.04", "26858", Some("WM_1.04")),
		...
		"ST_A1.01" -> MapLocation("WA1.01", "19194", Some("ST_A1.01")),
		"IB_M1" -> MapLocation("M1.14", "37315", Some("IB_M1")),
		...
		"IN_MM1 (PC room - Westwood)" -> MapLocation("Multimedia Lab 1", "50593", Some("IN_MM1 (PC room - Westwood)")),
		...
		"SM_336" -> MapLocation("H3.36", "21621", Some("SM_336")),
		...
		"LA_S2.12" -> MapLocation("AS2.12", "33364", Some("LA_S2.12")),
		...
		"ES_F2.11" -> MapLocation("D0.02 Mezzanine", "30952", Some("ES_F2.11")),
		...
		"ST_C0.08" -> MapLocation("IER office", "37663", Some("ST_C0.08")),
		...
		"WM_0.06" -> MapLocation("0.06", "19670", Some("WM_0.06")),
		...
		"WM_2.23" -> MapLocation("IMC1.08", "46054", Some("WM_2.23")),
		...
		"WM_L0.09" -> MapLocation("S0.09", "47897", Some("WM_L0.09")),
		"WM_L0.10" -> MapLocation("S0.10", "47868", Some("WM_L0.10")),
		"WM_L0.12" -> MapLocation("S0.12", "47879", Some("WM_L0.12")),
		"WM_L0.11" -> MapLocation("S0.11", "47892", Some("WM_L0.11")),
		"WM_S0.12" -> MapLocation("S0.12", "47879", Some("WM_S0.12")),
		...
		"WM_0.08" -> MapLocation("CS0.08", "26803", Some("WM_0.08")),
		...
		"LL_H0.72" -> MapLocation("H0.72", "21357")
	)
}
