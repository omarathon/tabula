...
class RecordMonitoringPointCommandTest extends TestBase with Mockito {
  ...
  trait StudentDatasFixture extends Fixture {
    val thisStudentDatas =
      Seq(
        AttendanceMonitoringStudentData(student1.firstName, student1.lastName, student1.universityId, "", new LocalDate, None, null, null, null, null, tier4Requirements = false, null, None),
        AttendanceMonitoringStudentData(student2.firstName, student2.lastName, student2.universityId, "", new LocalDate, None, null, null, null, null, tier4Requirements = false, null, None),
        AttendanceMonitoringStudentData(student3.firstName, student3.lastName, student3.universityId, "", new LocalDate, None, null, null, null, null, tier4Requirements = false, null, None)
      )
  }
  ...
  trait ValidatorFixture extends Fixture {
    ...
    validator.studentDatas = Seq(
      AttendanceMonitoringStudentData(null, null, student1.universityId, null, null, null, null, null, null, null, tier4Requirements = false, null, None),
      AttendanceMonitoringStudentData(null, null, student2.universityId, null, null, null, null, null, null, null, tier4Requirements = false, null, None),
      AttendanceMonitoringStudentData(null, null, student3.universityId, null, null, null, null, null, null, null, tier4Requirements = false, null, None)
    )
