...
class ListStudentGroupAttendanceCommandTest extends TestBase with Mockito {
  ...
  @Test
  def commandApplyAttendedAll() = withFakeTime(baseLocalDateTime) {
    new Fixture() {
      withFakeTime(now) {
  ...
  @Test
  def commandApplyAttendedMost() = withFakeTime(baseLocalDateTime) {
    new Fixture() {
      withFakeTime(now) {
  ...
  @Test
  def commandApplyAttendedSome() = withFakeTime(baseLocalDateTime) {
    new Fixture() {
      withFakeTime(now) {
