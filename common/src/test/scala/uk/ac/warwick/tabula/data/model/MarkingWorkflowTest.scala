...
class MarkingWorkflowTest extends TestBase with Mockito {
  ...
  @Test def studentsChooseMarker() = withUser("cuscav", "0000001") {
    new MarkingWorkflowFixture {
  ...
  @Test def seenSecondMarkingLegacy() = withUser("cuscav", "1234567") {
    new MarkingWorkflowFixture {
  ...
  @Test def seenSecondMarking() = withUser("cuscao", "1234567") {
    new MarkingWorkflowFixture {
  ...
  @Test def moderatedMarking() = withUser("curef", "1234567") {
    new MarkingWorkflowFixture {
  ...
  @Test def assignmentMarkerMap() {
    new MarkerMapFixture {
