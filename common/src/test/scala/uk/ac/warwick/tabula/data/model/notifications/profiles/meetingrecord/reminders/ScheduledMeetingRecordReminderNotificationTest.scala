...
class ScheduledMeetingRecordReminderNotificationTest extends TestBase {
  ...
  @Test def titleForStudent() = withFakeTime(new DateTime(2014, DateTimeConstants.SEPTEMBER, 15, 9, 39, 0, 0)) {
    new TitleFixture {
  ...
  @Test def titleForTutor() = withFakeTime(new DateTime(2014, DateTimeConstants.SEPTEMBER, 15, 9, 39, 0, 0)) {
    new TitleFixture {
  ...
  @Test def titleForStudentAfterTheFact() = withFakeTime(new DateTime(2014, DateTimeConstants.SEPTEMBER, 18, 9, 39, 0, 0)) {
    new TitleFixture {
      val notification: ScheduledMeetingRecordReminderStudentNotification = Notification.init(new ScheduledMeetingRecordReminderStudentNotification, new AnonymousUser, meeting)
