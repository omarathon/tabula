...
class MarksExtractionListenerTest extends TestBase with Logging with Mockito {
  ...
  val s1 = new User("0123456") {
    setFoundUser(true); setWarwickId("0123456")
  }
  val s2 = new User("0123457") {
    setFoundUser(true); setWarwickId("0123457")
  }
  val s3 = new User("1170836") {
    setFoundUser(true); setWarwickId("1170836")
  }
  val s4 = new User("1186549") {
    setFoundUser(true); setWarwickId("1170836")
  }
  val s5 = new User("1120365") {
    setFoundUser(true); setWarwickId("1186549")
  }
  val s6 = new User("1147650") {
    setFoundUser(true); setWarwickId("1120365")
  }
  val s7 = new User("1115345") {
    setFoundUser(true); setWarwickId("1147650")
  }
  val s8 = new User("1985435") {
    setFoundUser(true); setWarwickId("1115345")
  }
  val s9 = new User("1875610") {
    setFoundUser(true); setWarwickId("1985435")
  }
  val s10 = new User("1651020") {
    setFoundUser(true); setWarwickId("1875610")
  }
  val s11 = new User("1598452") {
    setFoundUser(true); setWarwickId("1651020")
  }
  val s12 = new User("1651508") {
    setFoundUser(true); setWarwickId("1598452")
  }
