...
trait MarkingWorkflowWorld extends TestHelpers with Mockito {
  ...
  mockUserLookup.registerUserObjects(
    new User("cusxad") {
      setWarwickId("9876004"); setFoundUser(true); setVerified(true);
    },
    new User("cuscao") {
      setWarwickId("0270954"); setFoundUser(true); setVerified(true);
    },
    new User("curef") {
      setWarwickId("9170726"); setFoundUser(true); setVerified(true);
    },
    new User("cusebr") {
      setWarwickId("0672088"); setFoundUser(true); setVerified(true);
    },
    new User("cuscav") {
    ...
    new User("cuslaj") {
      setWarwickId("1170836"); setFoundUser(true); setVerified(true);
    },
    new User("cuslat") {
      setWarwickId("1171795"); setFoundUser(true); setVerified(true);
    },
    new User("cuday") {
      setWarwickId("7170124"); setFoundUser(true); setVerified(true);
    }
  )
