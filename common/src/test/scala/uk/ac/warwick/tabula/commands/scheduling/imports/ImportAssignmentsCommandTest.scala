...
class ImportAssignmentsCommandTest extends FlatSpec with Matchers with Mockito {
  ...
  it should "process all collections" in {
    new Fixture {
      ...
      val registrations = Seq(
        UpstreamModuleRegistration("13/14", "0100001/1", "1", "A", "A01", "HI33M-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100001/1", "1", "A", "A01", "HI100-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "2", "A", "A01", "HI101-30", "A", "", "", "", "", "", "", "", "", resitExpected = false)
      )
  ...
  it should "process empty groups" in {
    new Fixture {
      val registrations = Seq(
        UpstreamModuleRegistration("13/14", "0100001/1", "1", "A", "A01", "HI33M-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "2", "A", "A01", "HI33M-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100003/1", "3", "A", "A01", "HI100-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "2", "A", "A01", "HI100-30", "A", "", "", "", "", "", "", "", "", resitExpected = false)
      )
  ...
  it should "set seat number to null where there is ambiguity" in {
    new Fixture {
      val registrations = Seq(
        ...
        UpstreamModuleRegistration("13/14", "0100001/1", "1", "A", "A01", "HI33M-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "2", "A", "A01", "HI33M-30", "A", "", "", "", "", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "3", "A", "A01", "HI33M-30", "A", "", "", "", "", "", "", "", "", resitExpected = false)
      )
  ...
  it should "set marks and grades to null where there is ambiguity" in {
    new Fixture {
      val registrations = Seq(
        UpstreamModuleRegistration("13/14", "0100001/1", "1", "A", "A01", "HI33M-30", "A", "34", "21", "34", "21", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100001/1", "1", "A", "A01", "HI33M-30", "A", "34", "F", "34", "F", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "2", "A", "A01", "HI33M-30", "A", "67", "21", "72", "1", "", "", "", "", resitExpected = false),
        UpstreamModuleRegistration("13/14", "0100002/1", "3", "A", "A01", "HI33M-30", "A", "67", "21", "72", "1", "", "", "", "", resitExpected = false)
      )
