...
class ListSmallGroupSetUnallocatedStudentsCommandTest extends TestBase with Mockito {
  ...
  @Test
  def oneStudentInAGroup() = withUser("cutrue") {
    new Fixture() {
      group1.students.add(user1)
  ...
  @Test
  def checkCurrentUserIsInGroup() = withUser("cutrue") {
    new Fixture() {
  ...
  @Test
  def sevenStudentsInOneGroup() = withUser("cutrue") {
    new Fixture() {
  ...
  @Test
  def sixStudentsAllocatedAcrossGroups() = withUser("cutrue") {
    new Fixture() {
