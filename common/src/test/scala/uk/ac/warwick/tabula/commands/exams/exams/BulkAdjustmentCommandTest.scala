...
class BulkAdjustmentCommandTest extends TestBase with Mockito {
  ...
  @Test
  def bindValidationBadExtension() {
    new BindFixture {
  ...
  @Test
  def bindValidationExtractDataValidStudent() {
    new BindFixture {
  ...
  @Test
  def validateInvalidGradeNoValidation() {
    new ValidateFixture {
