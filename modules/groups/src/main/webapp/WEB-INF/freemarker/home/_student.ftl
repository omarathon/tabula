...
<#if nonempty(memberGroupsetModules.moduleItems) || user.student>
	<div class="header-with-tooltip" id="my-groups">
		...
		<span class="use-tooltip" data-toggle="tooltip" data-html="true" data-placement="bottom" data-title="Talk to your module convenor if you think a seminar, lab or tutorial is missing - maybe it isn't set up yet, or they aren't using Tabula.">Missing a group?</span>
	</div>
