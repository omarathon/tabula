...
<#macro batchopen department><@url page="/admin/department/${department.code}/groups/open"  /></#macro>
...
<#macro openset set><@url page="/admin/module/${set.module.code}/groups/${set.id}/open" /></#macro>
