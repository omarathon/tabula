	...
	<form method="POST" action="">
		...
		<details class="manually-added" <#if expandManual>open</#if>>
			<summary class="large-chevron collapsible">
				...
				<p>
					<input class="btn" type="submit" name="${ManageDepartmentSmallGroupsMappingParameters.manuallyAddForm}" value="Add students manually" />
				</p>
			</summary>
	...
	<div class="fix-footer submit-buttons">
		<form action="${returnTo}" method="POST">
			...
			<input
				...
				name="${ManageDepartmentSmallGroupsMappingParameters.linkToSits}"
				data-container="body"
			...
			<input
				...
				name="${ManageDepartmentSmallGroupsMappingParameters.importAsList}"
				data-container="body"
				data-html="true"
				title="Import these students into a static list which will <strong>not</strong> be updated from SITS"
			>
			<input type="submit" value="Cancel" class="btn" name="${ManageDepartmentSmallGroupsMappingParameters.reset}">
		</form>
	</div>
</div>
