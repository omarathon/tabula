								...
								<div class="drag-target well clearfix">
									<div class="group-header">
										...
										<div>
											...
											<a id="show-list-${group.id}" class="show-list" title="View students" data-container=".groups" data-title="${popoverHeader}" data-prelude="${groupDetails}" data-placement="left"><i class="icon-question-sign"></i></a>
										</div>
									</div>
