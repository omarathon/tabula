...
import uk.ac.warwick.tabula.groups.commands.{ListSmallGroupSetStudentsCommand, StudentsInformation}
import uk.ac.warwick.tabula.web.Mav

@Controller
@RequestMapping(value=Array("/{smallGroupSet}/studentspopup"))
