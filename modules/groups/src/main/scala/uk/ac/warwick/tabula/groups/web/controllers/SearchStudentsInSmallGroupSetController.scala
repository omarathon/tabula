...
import uk.ac.warwick.tabula.groups.commands.SearchStudentsInSmallGroupSetCommand
import uk.ac.warwick.tabula.web.views.{JSONView, JSONErrorView}
import scala.collection.JavaConverters._

@RequestMapping(value = Array("/module/{module}/groups/{smallGroupSet}/students/search.json"))
@Controller
