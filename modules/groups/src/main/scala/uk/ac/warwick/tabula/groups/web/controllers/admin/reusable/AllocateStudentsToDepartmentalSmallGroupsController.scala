...
import uk.ac.warwick.tabula.groups.commands.admin.reusable.AllocateStudentsToDepartmentalSmallGroupsCommand
...
@Controller
@RequestMapping(value=Array("/admin/department/{department}/groups/reusable/new/{smallGroupSet}/allocate"))
class CreateDepartmentSmallGroupSetAllocateController extends AllocateStudentsToDepartmentalSmallGroupsController {
	override protected val renderPath = "admin/groups/reusable/allocateoncreate"
}

@Controller
@RequestMapping(value=Array("/admin/department/{department}/groups/reusable/edit/{smallGroupSet}/allocate"))
class EditDepartmentSmallGroupSetAllocateController extends AllocateStudentsToDepartmentalSmallGroupsController {
	override protected val renderPath = "admin/groups/reusable/allocateonedit"
}