...
/** Gets the data for a students view of all small groups they're a member of.
  *
	* //FIXME - the statement below IS NOT TRUE ANYMORE!!!! AAAAAAARRRRRRRRGGGGG!
  ...
  */
class ListStudentsGroupsCommandImpl(user: User)
	...
	def applyInternal() =
		smallGroupService.findSmallGroupsByStudent(user)
