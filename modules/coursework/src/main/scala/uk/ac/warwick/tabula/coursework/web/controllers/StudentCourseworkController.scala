...
import uk.ac.warwick.tabula.data.model.{Submission, Assignment, Member}
...
trait StudentCourseworkCommandHelper
	...
	def enhanced(assignment: Assignment, user: User, universityId: String) = {
	...
	def getAssignments = StudentAssignments(
