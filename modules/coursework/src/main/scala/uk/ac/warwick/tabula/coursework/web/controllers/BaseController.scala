...
import uk.ac.warwick.tabula.coursework.validators.CompositeValidator
...
trait ControllerViews {
	val Mav = uk.ac.warwick.tabula.coursework.web.Mav
	val Breadcrumbs = uk.ac.warwick.tabula.coursework.web.Breadcrumbs
