...
import uk.ac.warwick.tabula.coursework.actions.Deleteable
...
class Feedback extends GeneratedId with Viewable with Deleteable {
	...
	@Type(`type` = "uk.ac.warwick.tabula.coursework.data.model.OptionBooleanUserType")
	var ratingPrompt: Option[Boolean] = None
	@Type(`type` = "uk.ac.warwick.tabula.coursework.data.model.OptionBooleanUserType")
	var ratingHelpful: Option[Boolean] = None

	@Type(`type` = "uk.ac.warwick.tabula.coursework.data.model.OptionIntegerUserType")
