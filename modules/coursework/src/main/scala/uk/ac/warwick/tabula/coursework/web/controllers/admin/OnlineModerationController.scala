...
import uk.ac.warwick.tabula.coursework.commands.feedback.{GenerateGradeFromMarkCommand, OnlineModerationCommand}
...
class OnlineModerationController extends CourseworkController {
	...
	) = OnlineModerationCommand(module, assignment, student, marker, submitter, GenerateGradeFromMarkCommand(mandatory(module), mandatory(assignment)))
