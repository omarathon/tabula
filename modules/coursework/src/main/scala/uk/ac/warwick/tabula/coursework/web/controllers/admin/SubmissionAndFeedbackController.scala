...
class SubmissionAndFeedbackController extends CourseworkController {
	...
	def list(command: SubmissionAndFeedbackCommand) = {
		...
		Mav("admin/assignments/submissionsandfeedback/list",
			...
			"awaitingSubmissionWithinExtension" -> command.awaitingSubmissionWithinExtension,
			"awaitingSubmissionExtensionRequested" -> command.awaitingSubmissionExtensionRequested,			
			"awaitingSubmissionExtensionExpired" -> command.awaitingSubmissionExtensionExpired,
			"awaitingSubmissionExtensionRejected" -> command.awaitingSubmissionExtensionRejected,
			"awaitingSubmissionNoExtension" -> command.awaitingSubmissionNoExtension,
