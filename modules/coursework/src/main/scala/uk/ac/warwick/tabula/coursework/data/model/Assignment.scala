...
import uk.ac.warwick.tabula.coursework.actions.Viewable
...
import uk.ac.warwick.tabula.coursework.data.model.forms.FormField
import uk.ac.warwick.tabula.helpers.DateTimeOrdering.orderedDateTime
import uk.ac.warwick.tabula.helpers.ArrayList
import uk.ac.warwick.tabula.CurrentUser
import uk.ac.warwick.tabula.coursework.{ AcademicYear, ToString, Features }
...
class Assignment() extends GeneratedId with Viewable with CanBeDeleted with ToString {
	...
	@Basic
	@Type(`type` = "uk.ac.warwick.tabula.coursework.data.model.AcademicYearUserType")
	@Column(nullable = false)
	var academicYear: AcademicYear = AcademicYear.guessByDate(new DateTime())

	@BeanProperty var occurrence: String = _

	@Type(`type` = "uk.ac.warwick.tabula.coursework.data.model.StringListUserType")
