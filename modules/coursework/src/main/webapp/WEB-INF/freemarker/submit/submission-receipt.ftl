...
<#if assignment.findExtension(user.universityId)??>
	<#assign extension=assignment.findExtension(user.universityId) />
</#if>
...
<body>
	...
	<h2>Submission receipt for ${user.universityId}</h2>
