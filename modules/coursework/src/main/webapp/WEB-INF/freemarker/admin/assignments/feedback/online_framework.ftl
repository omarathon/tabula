...
<h5><span class="muted">for</span> ${assignment.name} (${assignment.module.code?upper_case})</h5>
	...
	<div class="btn-toolbar">
		<div class="btn-group-group">
			...
			<div class="btn-group">
				<a id="marking-complete-button" data-container="body" class="must-have-selected btn use-tooltip form-post" href="<@routes.markingCompleted assignment marker />" title="" data-original-title="Finalise marks and feedback. Changes cannot be made to marks or feedback files after this point.">
					<i class="icon-ok"></i>
					Marking completed
				</a>
			</div>
