	...
	<div id="tip-content-${attachment.id}" class="hide">
		...
		<p>
			...
			<#elseif (user.sysadmin)!false && features.turnitinLTI && !r.turnitinId?has_content>
				<a target="turnitin-viewer" href="<@url page='/coursework/admin/module/${assignment.module.code}/assignments/${assignment.id}/turnitin-report/${attachment.id}'/>">View full report - available to sysadmins only whilst the api is available</a>
