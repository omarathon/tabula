...
<@f.form method="post" action="${formAction}" commandName="releaseForMarkingCommand">
	...
	<#else>
		<div class="alert alert-warning">
			None of the students that you selected can be released for marking. <a href="<@routes.assignmentsubmissionsandfeedback assignment />">Go back to the assignment summary.</a>
		</div>
	</#if>
