...
class PublishFeedbackCommandTest extends TestBase {
	...
	trait World {
		...
		val queueFeedbackForSitsCommand = new QueueFeedbackForSitsCommand(assignment, currentUser)
		val command = new PublishFeedbackCommand(assignment.module, assignment, currentUser, queueFeedbackForSitsCommand)
