...
import uk.ac.warwick.tabula.coursework.data.model.{Assignment, AuditEvent, Submission}
...
import uk.ac.warwick.tabula.coursework.JsonObjectMapperFactory
import uk.ac.warwick.tabula.helpers.ArrayList
import java.io.File
import uk.ac.warwick.tabula.coursework.commands.assignments.{AddAssignmentCommand, DownloadSubmissionsCommand}
import uk.ac.warwick.tabula.coursework.events.EventHandling
import uk.ac.warwick.tabula.coursework.events.EventListener
import uk.ac.warwick.tabula.coursework.events.Event
