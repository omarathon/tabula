...
trait GenerateTurnitinReportUriApi {
	...
	def create(@RequestBody request: GenerateTurnitinReportRequest, @ModelAttribute("generateReportUriCommand") command: ViewPlagiarismReportCommand, errors: BindingResult) = {
