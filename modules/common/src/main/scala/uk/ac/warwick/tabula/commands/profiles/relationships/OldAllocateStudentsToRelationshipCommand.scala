...
import uk.ac.warwick.tabula.commands.{Command, Description, GroupsObjectsWithFileUpload, MemberCollectionHelper, SelfValidating}
import uk.ac.warwick.tabula.data.Transactions._
import uk.ac.warwick.tabula.data.model.{Department, FileAttachment, Member, StudentMember, StudentRelationshipType}
import uk.ac.warwick.tabula.helpers.ReverseMapHelper.reverseMap
import uk.ac.warwick.tabula.helpers.StringUtils._
import uk.ac.warwick.tabula.permissions.Permissions
import uk.ac.warwick.tabula.services.profiles.docconversion.RawStudentRelationshipExtractor
...
class OldAllocateStudentsToRelationshipCommand(val department: Department, val relationshipType: StudentRelationshipType, val viewer: CurrentUser)
