package uk.ac.warwick.tabula.commands.attendance.view.old
...
import uk.ac.warwick.tabula.commands.attendance.old.{AutowiringSecurityServicePermissionsAwareRoutes, GroupMonitoringPointsByTerm, GroupedMonitoringPoint, PermissionsAwareRoutes}
