...
abstract class Features {
	...
	@Value("${features.smallGroupTeaching.crossModuleSmallGroups:false}") var smallGroupCrossModules = defaults.smallGroupCrossModules
...
class FeaturesMessage {
	...
	@BeanProperty var smallGroupCrossModules = false
