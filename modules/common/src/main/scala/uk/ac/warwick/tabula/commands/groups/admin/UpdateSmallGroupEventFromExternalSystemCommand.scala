...
import uk.ac.warwick.tabula.services.timetables.{TimetableEmptyException, AutowiringScientiaConfigurationComponent, ModuleTimetableFetchingServiceComponent, ScientiaHttpTimetableFetchingServiceComponent}
