...
class TurnitinClassDeletedNotificationTest extends TestBase {
	...
	@Test def title() = withUser("cuscav", "0672089") {
		...
		val notification = Notification.init(new TurnitinClassDeletedNotification, currentUser.apparentUser, report, assignment)
