...
class FeedbackPublishedNotificationTest extends TestBase {
	...
	@Test def title() = withUser("cuscav", "0672089") {
		...
		notification.title should be ("CS118: Your assignment feedback for \"5,000 word essay\" is now available")
	}
