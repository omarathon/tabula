...
<div class="fix-area">
	<@components.assignment_wizard 'review' assignment.module false assignment/>
	...
	<div class="form-group">
		<#assign feedbackDetailsUrl><@routes.cm2.editassignmentfeedback assignment /></#assign>
	...
	<div class="form-group">
		<#assign studentDetailsUrl><@routes.cm2.editassignmentstudents assignment /></#assign>
	...
	<div class="form-group">
		<#assign markerDetailsUrl><@routes.cm2.editassignmentmarkers assignment /></#assign>
		<@review_details_header 'Marker details' markerDetailsUrl />
		<!--TODO- Integrate this after assignment marker impl-->
	</div>

	<div class="form-group">
		<#assign submissionDetailsUrl><@routes.cm2.editassignmentsubmissions assignment /></#assign>
	...
	<div class="form-group">
		<#assign optionDetailsUrl><@routes.cm2.editassignmentoptions assignment /></#assign>
