<#if detail.extension?has_content>
	...
	<#else>
		<#if (detail.extension._state.decription?has_content && detail.extension._state.decription != "Revoked")>
			<div>
...
<div class="content extension-detail">
	...
	<@f.form method="post" enctype="multipart/form-data" action=actionUrl commandName="editExtensionCommand" cssClass="form-horizontal double-submit-protection modify-extension">
