...
<p>Drag modules by their <i class='icon-reorder fa fa-bars'></i> handles to move them between departments. To select multiple departments,
drag a box from one module name to another. You can also hold the <kbd class="keyboard-control-key">Ctrl</kbd> key and drag to add to a selection.</p>
...
<@f.form commandName="sortModulesCommand" action="${url('/admin/department/${department.code}/sort-modules')}">
