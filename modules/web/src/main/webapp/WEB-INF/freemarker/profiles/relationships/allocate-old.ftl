...
<#escape x as x?html>
	...
	<#macro deptheaderroutemacro dept>
		<@routes.profiles.relationship_allocate_old dept relationshipType />
	</#macro>
	...
	<#assign submitUrl><@routes.profiles.relationship_allocate_old department relationshipType /></#assign>
				...
				<div class="tabula-dnd"
					...
					<div class="row-fluid fix-on-scroll-container">
						...
						<div class="submit-buttons fix-footer">
							...
							<a href="<@routes.profiles.home />" class="btn">Cancel</a> <#-- TODO better url -->
						</div>
