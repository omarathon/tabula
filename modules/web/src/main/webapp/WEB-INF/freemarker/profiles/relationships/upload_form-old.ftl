...
<ol>
	<li>
		...
		<div class="alert alert-info">
			<p>This will include any changes made in the drag and drop tab. You can also <a href="<@routes.profiles.relationship_template_old department relationshipType />">download a template without these changes</a>.</p>
