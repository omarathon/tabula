	...
	<div id="allocatestudents-tab1" class="tab-pane active fix-area allocate-associations">
		...
		<@f.form commandName="command" action="${previewFormAction}" method="POST" cssClass="form-inline preview">
			...
			<div class="submit-buttons fix-footer">
				...
				<a href="<@routes.profiles.home />" class="btn">Cancel</a>
			</div>
		</@f.form>
	</div>
			...
			<ol>
				<li>
					...
					<div class="alert alert-info">
						<p>This will include any changes made in the drag and drop tab. You can also <a href="<@routes.profiles.relationship_template department relationshipType />">download a template without these changes</a>.</p>
					</div>
				</li>
