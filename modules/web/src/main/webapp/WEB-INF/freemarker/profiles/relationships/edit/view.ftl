	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
			...
			$('.inline-search-button').click(function() {
				...
				var target = "<@routes.profiles.relationship_search_json />";
			...
			profileSearch($('#edit-agent-modal .profile-search'), "<@routes.profiles.relationship_search_json />", agentHighlight, setStudent);
