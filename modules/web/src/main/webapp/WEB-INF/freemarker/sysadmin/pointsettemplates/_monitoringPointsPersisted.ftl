	...
	<#if command.template.points?size == 0>
		<div class="striped-section">
			<div class="pull-right">
				<a href="<@url page="/sysadmin/pointsettemplates/${command.template.id}/edit/points/add" />" class="btn btn-primary new-point"><i class="icon-plus fa fa-plus"></i> Create new point</a>
			</div>
            		...
            		<div class="item-info row-fluid point">
						<div class="span12">
							<div class="pull-right">
								...
								<a class="btn btn-danger delete-point" title="Delete" href="<@url page="/sysadmin/pointsettemplates/${command.template.id}/edit/points/${point.id}/delete"/>"><i class="icon-remove fa fa-times"></i></a>
							</div>
