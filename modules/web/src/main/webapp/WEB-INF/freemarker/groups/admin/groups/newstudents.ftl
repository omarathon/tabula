...
<#import "*/group_components.ftl" as components />
	...
	<div class="fix-area">
		<@f.form id="newStudents" method="POST" commandName="command" class="form-horizontal dirty-check">
			...
			<div class="submit-buttons fix-footer">
				<#if smallGroupSet.linked>
					<a class="btn btn-success" href="<@routes.groups.createsetevents smallGroupSet />">Add events</a>
				<#else>
					<input
						type="submit"
