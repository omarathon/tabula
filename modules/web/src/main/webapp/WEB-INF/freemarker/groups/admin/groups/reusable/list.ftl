...
<#function route_function dept>
	<#local result><@routes.groups.crossmodulegroups dept /></#local>
	<#return result />
</#function>
...
<#else>
	...
	<span class="very-subtle">There <@fmt.p number=sets?size singular="is" plural="are" shownumber=false/> <@fmt.p sets?size "reusable small group" /> in your department.</span>

	<p>
		<a class="btn btn-default" href="<@routes.groups.createcrossmodulegroups department />">Create reusable small groups</a>
	</p>
