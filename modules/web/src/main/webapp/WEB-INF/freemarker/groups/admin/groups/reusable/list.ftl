...
<#if department??>
	<@fmt.deptheader "Manage reusable small group allocations" "in" department routes.groups "crossmodulegroups" "with-settings" />
<#else>
	<p>No department.</p>
</#if>
	...
	<#if sets?size == 0>
		...
		<p>
			<a class="btn btn-primary" href="<@routes.groups.createcrossmodulegroups department />">Create reusable small groups</a>
		</p>
	...
	<#else>
		...
		<p>
			<a class="btn" href="<@routes.groups.createcrossmodulegroups department />">Create reusable small groups</a>
		</p>
			...
			<div class="row-fluid">
				<div class="span9 hover-highlight">
					<div class="pull-right" style="line-height:30px">
						<a class="btn btn-primary btn-mini" href="<@routes.groups.editcrossmodulegroups set />">Edit</a>
						<a class="btn btn-danger btn-mini" href="<@routes.groups.deletecrossmodulegroups set />"><i class="icon-remove"></i></a>
					</div>
