<div class="row-fluid">
	<div class="span6">
		...
		<div class="flexi-picker-container input-prepend input-append">
			<span class="add-on"><i class="icon-user"></i></span><#--
				...
				/>
			<button class="btn" type="submit" name="searchSingle" value="true"><i class="icon-search"></i></button>
		</div>
	...
	<div class="span6">
		...
		<button class="btn" type="submit" name="searchMulti" value="true" style="vertical-align: bottom"><i class="icon-search"></i></button>
	</div>
</div>
<hr />