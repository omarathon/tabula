...
<#if jobId??>
	...
	<div class="report-complete alert alert-success" style="display: none;">
		...
		<p><a href="<@routes.reports.profileExportReportZip department academicYear jobId />" class="btn"><i class="icon-download fa fa-arrow-circle-o-down"></i> Download reports as a .zip file</a></p>
	</div>
