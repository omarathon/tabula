...
<#assign thisPath><@routes.attendance.agentStudentView student relationshipType command.academicYear /></#assign>
...
<div class="monitoring-points">
	...
	<#else>
		<a class="btn btn-primary" href="<@routes.attendance.agentStudentRecord student relationshipType command.academicYear thisPath/>">Record attendance</a>
