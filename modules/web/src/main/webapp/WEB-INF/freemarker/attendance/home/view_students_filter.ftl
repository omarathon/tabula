...
<div class="pull-right send-to-sits">
	<a href="<@routes.attendance.report command.department command.academicYear filterQuery />" class="btn btn-primary">Upload to SITS:eVision</a>
</div>
...
<#assign submitUrl><@routes.attendance.viewDepartmentStudents command.department /></#assign>
