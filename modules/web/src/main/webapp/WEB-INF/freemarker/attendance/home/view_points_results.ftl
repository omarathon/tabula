...
<#else>
	...
	<#assign returnTo><@routes.attendance.viewDepartmentPointsWithAcademicYear command.department command.academicYear filterQuery/></#assign>
	<#function permission_button_function groupedPoint>
		<#local record_url><@routes.attendance.record command.department groupedPoint.pointId filterQuery returnTo/></#local>
		<#local result>
