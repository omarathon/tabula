					...
					<div class="item-info row-fluid point">
						<div class="span12">
							<div class="pull-right">
								<a class="btn btn-primary edit-point" href="<@routes.attendance.editPoint command.dept pointCount />?form=true">Update</a>
								<a class="btn btn-danger delete-point" title="Delete" href="<@routes.attendance.deletePoint command.dept pointCount />?form=true"><i class="icon-remove"></i></a>
							</div>
