...
<#assign thisPath><@routes.attendance.agentView command.relationshipType /></#assign>
...
<#else>
	...
	<#function view_url student>
		<#local return>
			<@routes.attendance.agentStudentView student command.relationshipType command.academicYear />
		</#local>
		<#return return/>
	</#function>
	...
	<#function record_url student>
		<#local return>
			<@routes.attendance.agentStudentRecord student command.relationshipType command.academicYear thisPath />
		</#local>
		<#return return/>
	</#function>
	...
	<#function permission_button_function groupedPoint>
		<#local record_url><@routes.attendance.agentPointRecord groupedPoint.pointId command.relationshipType thisPath /></#local>
		<#local result>
