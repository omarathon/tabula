...
<#assign thisPath><@routes.attendance.viewDepartmentAgents command.department command.relationshipType /></#assign>
			...
			<tr>
				...
				<td class="button">
					<#if agentData.agentMember?? >
						<a href="<@routes.attendance.viewDepartmentAgentsStudents command.department command.relationshipType agentData.agentMember />" class="btn btn-primary">Attendance</a>
					<#else>
						&nbsp;
					</#if>
				</td>
