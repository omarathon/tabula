...
<#assign confirmPath><@routes.attendance.reportConfirm command.department /></#assign>
	...
	<#else>
		...
		<div class="submit-buttons">
			<div class="pull-right">
				...
				<a class="btn" href="<@routes.attendance.viewDepartmentStudentsWithAcademicYear command.department command.academicYear command.serializeFilter />">Cancel</a>
			</div>
		</div>
	</#if>
