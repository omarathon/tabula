...
<#assign thisPath><@routes.attendance.viewStudent department student command.academicYear /></#assign>
...
<div class="monitoring-points">
	...
	<#else>
		<a class="btn btn-primary" href="<@routes.attendance.recordStudent department student command.academicYear thisPath/>">Record attendance</a>
