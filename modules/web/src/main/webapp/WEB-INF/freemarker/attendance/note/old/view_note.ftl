...
<#import "*/modal_macros.ftl" as modal />
		...
		<@modal.footer>
			<span class="submit-buttons">
				<#if can.do("MonitoringPoints.Record", attendanceNote.student) >
					<a href="<@routes.attendance.editNote attendanceNote.student attendanceNote.point />" class="btn btn-primary spinnable spinner-auto">
						Edit
					</a>
				</#if>
	...
	<#else>
		...
		<#if can.do("MonitoringPoints.Record", attendanceNote.student) >
			<a href="<@routes.attendance.editNote attendanceNote.student attendanceNote.point />" class="btn btn-primary spinnable spinner-auto">Edit</a>
		</#if>
