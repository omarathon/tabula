<#escape x as x?html>
	...
	<#if totalResults?? && students??>
		...
		<#assign sendToSitsUrl><@routes.attendance.report command.department command.academicYear filterQuery /></#assign>
		<div class="studentResults" data-sits-url="${sendToSitsUrl}">
		<#assign returnTo><@routes.attendance.viewDepartmentStudentsWithAcademicYear command.department command.academicYear filterQuery command.page/></#assign>
		<#if (totalResults > 0)>
							...
							<tbody>
								<#list students as studentData>
									<tr class="student">
										...
										<td class="id"><a class="profile-link" href="<@routes.attendance.profile studentData.student />">${studentData.student.universityId}</a></td>
									</tr>
								</#list>
							</tbody>
						</table>
						...
						<table class="table table-bordered table-striped table-condensed">
							...
							<tbody>
								<#list students as studentData>
									...
									<#else>
										<td class="unrecorded">
											<a href="<@routes.attendance.viewStudent command.department studentData.student command.academicYear />">
										...
										<td class="record">
											<#assign record_url><@routes.attendance.recordStudent command.department studentData.student command.academicYear returnTo /></#assign>
