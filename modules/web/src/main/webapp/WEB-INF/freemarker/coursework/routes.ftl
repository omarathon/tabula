...
<#macro downloadSingleSubmission assignment submission filename><@_u page="/admin/module/${assignment.module.code}/assignments/${assignment.id}/submissions/download/${submission.id}/${filename?url}?single=true"/></#macro>
