...
exports.prepareAjaxForm = function($form, callback) {
	...
	$form.ajaxForm({
		...
		statusCode: {
			403: function(jqXHR) {
				$container.html("<p>Sorry, you don't have permission to see that. Have you signed out of Tabula?</p><p>Refresh the page and try again. If it remains a problem, please let us know using the comments link on the edge of the page.</p>");
