...
import uk.ac.warwick.tabula.commands.attendance.view.old.SetMonitoringCheckpointForStudentCommand

@RequestMapping(Array("/attendance/{department}/{monitoringPoint}/record/{student}"))
@Controller
