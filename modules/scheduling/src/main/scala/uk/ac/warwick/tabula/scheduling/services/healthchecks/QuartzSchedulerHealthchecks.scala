...
object QuartzJdbc {
	...
	object TriggerState {
		...
		val members = Seq(Waiting, Acquired, Complete, Paused, Blocked, PausedBlocked, Error)
	...
	case class Trigger(name: String, jobName: String, lastFired: Option[DateTime], nextFire: DateTime, state: TriggerState)
	object Trigger {
