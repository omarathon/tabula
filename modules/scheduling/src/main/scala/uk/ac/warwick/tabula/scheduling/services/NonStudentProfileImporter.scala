...
import uk.ac.warwick.tabula.scheduling.commands.imports.ImportSingleMemberFromMembershipCommand
...
@Service
class NonStudentProfileImporter extends Logging {
	import NonStudentProfileImporter._
	...
	def getMemberDetails(membersAndCategories: Seq[MembershipInformation], users: Map[String, User]): Seq[ImportSingleMemberFromMembershipCommand] = {
...
object NonStudentProfileImporter {
