	...
	<div id="tutor-upload-form">
		...
		<p>You can set personal tutors for many students at once by uploading a spreadsheet.
			<a href="#"
				...
				data-html="true"
				data-content="&lt;p&gt;The spreadsheet must be in &lt;samp&gt;.xlsx&lt;/samp&gt; format (created in Microsoft Excel 2007 or newer, or another compatible spreadsheet application). You can download a template spreadsheet which is correctly formatted, ready for completion.&lt;p&gt;
