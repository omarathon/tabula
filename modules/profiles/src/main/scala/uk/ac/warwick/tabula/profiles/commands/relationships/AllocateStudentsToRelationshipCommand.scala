...
import uk.ac.warwick.tabula.profiles.commands.relationships.ExtractRelationshipsFromFileCommand.AllocationTypes
import uk.ac.warwick.tabula.services.{AutowiringProfileServiceComponent, ProfileServiceComponent, AutowiringRelationshipServiceComponent, RelationshipServiceComponent}
