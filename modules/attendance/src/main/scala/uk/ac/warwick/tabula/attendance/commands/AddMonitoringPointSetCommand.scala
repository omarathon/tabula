...
abstract class AddMonitoringPointSetCommand(val dept: Department, val existingSetOption: Option[MonitoringPointSet]) extends CommandInternal[mutable.Buffer[MonitoringPointSet]]
