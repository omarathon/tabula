...
<#assign confirmPath><@routes.viewReportConfirm department academicYear.startYear?c /></#assign>
	...
	<#else>
		...
		<div class="submit-buttons">
			<div class="pull-right">
				...
				<a class="btn" href="<@routes.viewStudents department academicYear.startYear?c command.serializeFilter />">Cancel</a>
			</div>
		</div>
	</#if>
