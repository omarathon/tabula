...
<div class="btn-toolbar dept-toolbar">
	<#if command.department.parent??>
		<a class="btn btn-medium use-tooltip" href="<@routes.viewDepartment command.department.parent />" data-container="body" title="${command.department.parent.name}">
			Parent department
		</a>
	</#if>
...
<#assign thisPath><@routes.viewDepartment command.department /></#assign>
<@attendance_macros.academicYearSwitcher thisPath command.academicYear command.thisAcademicYear />

<div class="persist-area">
	<div class="persist-header">
		<#assign submit_url><@routes.viewDepartment command.department /></#assign>
	...
	<div id="filter-results">
		<#include "view_points_results.ftl" />
	</div>
</div>
