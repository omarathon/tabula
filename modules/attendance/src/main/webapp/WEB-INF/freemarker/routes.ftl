...
<#--
	...
	<#macro recordStudent department student academicYear returnTo><@url page="/${department.code}/students/record/${student.universityId}?academicYear=${academicYear.toString}&returnTo=${returnTo?url}" /></#macro>
