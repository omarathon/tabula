...
<#escape x as x?html>
	...
	<div class="overrides">
		...
		<p><a class="btn" href="<@routes.addcustomroleoverride customRoleDefinition />"><i class="icon-plus"></i> Create</a></p>
				...
				<tbody>
					<#list roleInfo.overrides as override>
						...
						<tr>
							...
							<td class="actions">
								<a class="btn btn-mini btn-danger" href="<@routes.deletecustomroleoverride override />" data-toggle="modal" data-target="#custom-roles-modal"><i class="icon-remove icon-white"></i> Delete</a>
							</td>
						</tr>
					</#list>
				</tbody>
