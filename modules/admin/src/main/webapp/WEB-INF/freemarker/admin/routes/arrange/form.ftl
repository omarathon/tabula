...
drag a box from one route name to another. You can also hold the <kbd class="keyboard-control-key">Ctrl</kbd> key to add to a selection.</p>
...
<@f.form commandName="sortRoutesCommand" action="${url('/department/${department.code}/sort-routes')}">
