<#escape x as x?html>
	...
	<p><a class="btn" href="<@routes.addcustomrole department />"><i class="icon-plus"></i> Create</a></p>
				...
				<#list customRoles as info>
					...
					<tr>
						...
						<td>
							...
							<a class="btn btn-mini" href="<@routes.customroleoverrides customRoleDefinition />"><i class="icon-edit"></i> +<@fmt.p customRoleDefinition.overrides?size "override"/></a>
						</td>
						<td>
							<a class="btn btn-mini" href="<@routes.editcustomrole customRoleDefinition />"><i class="icon-edit"></i> Modify</a>
							<a class="btn btn-mini btn-danger<#if !canDelete> use-tooltip disabled</#if>" href="<@routes.deletecustomrole customRoleDefinition />" data-toggle="modal" data-target="#custom-roles-modal"<#if !canDelete> title="You can't delete this custom role as it is in use by <@fmt.p info.grantedRoles "granted role" /> and <@fmt.p info.derivedRoles "derived role definition" />."</#if>><i class="icon-remove icon-white"></i> Delete</a>
						</td>
					</tr>
				</#list>
			</tbody>
