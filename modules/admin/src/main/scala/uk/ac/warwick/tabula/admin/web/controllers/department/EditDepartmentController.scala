...
import uk.ac.warwick.tabula.admin.commands.department.{EditDepartmentCommand, EditDepartmentCommandState}
...
@Controller
@RequestMapping(value = Array("/department/{department}/edit"))
