...
import uk.ac.warwick.tabula.admin.commands.permissions.BuildPermissionsTreeCommand
import uk.ac.warwick.tabula.admin.commands.permissions.BuildPermissionsTreeCommand.PermissionsTree
...
@Controller @RequestMapping(value = Array("/permissions/department/{target}/tree"))
class DepartmentPermissionsTreeController extends PermissionsTreeControllerMethods[Department]

@Controller @RequestMapping(value = Array("/permissions/module/{target}/tree"))
class ModulePermissionsTreeController extends PermissionsTreeControllerMethods[Module]

@Controller @RequestMapping(value = Array("/permissions/route/{target}/tree"))
