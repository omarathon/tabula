      ...
      setup: function () {
        ...
        $('#download-selected-button, #delete-selected-button', $outerContainer).click(function (event) {
          ...
          if ($container.data('checked') != 'none') {
            var $form = window.GlobalScripts.csrfForm.generate().attr({method: 'POST', action: this.href}).hide();
        ...
        $('.form-post', $outerContainer).click(function (event) {
          ...
          if (!$this.hasClass("disabled")) {
            ...
            var $form = window.GlobalScripts.csrfForm.generate().attr({method: 'POST', action: action}).hide();
    ...
    $('.marker-feedback-table').bigList(
      $.extend(biglistOptions, {
        onSomeChecked: function () {
          ...
          if (allBlank) {
            $sendBack.removeClass("disabled");
          } else {
            $sendBack.addClass("disabled");
          }
          if (allPopulated) {
            $sendForward.removeClass("disabled");
          } else {
