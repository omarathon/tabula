<#escape x as x?html>
  ...
  <#if (activeSpringProfiles!"") == "sandbox">
    <div class="alert alert-block">
      ...
      <p>To get access to administration on this system, please send an email to <a href="mailto:tabula@warwick.ac.uk?subject=Sandbox access">tabula@warwick.ac.uk</a>
      </p>
