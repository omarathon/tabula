...
<#escape x as x?html>
  ...
  <div class="row">
    <div class="col-md-9">
      ...
      <div class="boxstyle_ box3">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <p><a target="_blank" href="http://www2.warwick.ac.uk/services/its/servicessupport/web/tabula/manual/administration-permissions/">Administration
                  and permissions<i class="new-window-link" title="Link opens in a new window"></i></a></p>
              <p><a target="_blank" href="http://www2.warwick.ac.uk/services/its/servicessupport/web/tabula/manual/cm2/">Coursework management<i
                          class="new-window-link" title="Link opens in a new window"></i></a></p>
              <p><a target="_blank" href="http://www2.warwick.ac.uk/services/its/servicessupport/web/tabula/manual/grids/">Exam grids<i class="new-window-link"
                                                                                                                                        title="Link opens in a new window"></i></a>
              </p>
            </div>
            <div class="col-sm-6">
              <p><a target="_blank" href="http://www2.warwick.ac.uk/services/its/servicessupport/web/tabula/manual/monitoring-points/">Monitoring points<i
                          class="new-window-link" title="Link opens in a new window"></i></a></p>
              <p><a target="_blank" href="http://www2.warwick.ac.uk/services/its/servicessupport/web/tabula/manual/profiles/">Profiles<i class="new-window-link"
                                                                                                                                         title="Link opens in a new window"></i></a>
              </p>
              <p><a target="_blank" href="http://www2.warwick.ac.uk/services/its/servicessupport/web/tabula/manual/small-group-teaching/">Small group teaching<i
                          class="new-window-link" title="Link opens in a new window"></i></a></p>
            </div>
          </div>
        </div>
      ...
      <div class="boxstyle_ box2">
        ...
        <p>If you need help with an exam grid for an area not covered in the Manual, please <a target="_blank"
                                                                                               href="https://warwick.ac.uk/services/its/servicessupport/web/tabula/request-exam-grid-help">complete
            this web form</a></p>
      </div>
    ...
    <div class="col-md-3">
      <div class="boxstyle_ box2">
        <h4>Notice board</h4>
        <p>Visit the <a href="https://warwick.ac.uk/tabulainfo/forum">Tabula notice board</a> for updates on new developments, events and other news from the
          Tabula team.</p>
        <h4>Release notes</h4>
        <p>We regularly release updated versions of Tabula. Read the <a href="https://warwick.ac.uk/tabulainfo/releases">release notes</a> to learn about new
          features, improvements and bug fixes in each version.</p>
      </div>
      <div class="boxstyle_ box2">
