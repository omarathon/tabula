  ...
  <#else>
    ...
    <div class="row">
      <div class="col-md-<#if is_admin>6<#else>12</#if>">
        ...
        <#if isPGR && !shownProfileLink??>
          <#if universityId?has_content>
            <h2><a href="<@routes.profiles.profile_by_id universityId />">My postgraduate profile</a></h2>
          </#if>
        </#if>
        ...
        <#elseif is_staff>
          ...
          <p>
            You are not currently a tutor for any group of students in Tabula. If you think this is incorrect or you need assistance, please visit our <a
