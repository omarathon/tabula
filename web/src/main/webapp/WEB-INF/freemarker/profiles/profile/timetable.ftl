...
<#escape x as x?html>
  ...
  <div class="calendar-outer">
    <div class="calendar-loading hidden-print">
      ...
      <p>Please wait &mdash; the timetable is being loaded.</p>
    </div>
  ...
  <p>
    <a class="btn btn-default calendar-download hidden-xs" href="<@routes.profiles.timetable_calendar_download member />"
       data-href="<@routes.profiles.timetable_calendar_download member />">
      Download calendar as PDF
    </a>
    <#if academicYear??>
      <a class="btn btn-default timetable-download" href="<@routes.profiles.timetable_download member academicYear />"
         data-href="<@routes.profiles.timetable_download member academicYear />">
    ...
    <@modal.modal id="timetable-ical-modal">
      <@modal.wrapper>
        ...
        <@modal.body>
          <#if isSelf>
            <div class="alert alert-info">
              <p>Tabula provides your timetable as a calendar feed with a "private address". Private Addresses are designed for your use only. They don't
                require any further authentication to get information from your timetable, so they're useful for getting your timetable into another calendar or
          ...
          <p>You can <a href="<@routes.profiles.timetable_ical member />">click this link</a> to subscribe to your timetable in your default calendar
            application.</p>
