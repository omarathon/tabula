          ...
          <tr>
            ...
            <td>
              <#if relationship.startDate??>
                <span tabindex="0" role="button" class="use-tooltip" data-container="body"
            ...
            <td>
              <#if relationship.endDate??>
                <span tabindex="0" role="button" class="use-tooltip" data-container="body" title="<@fmt.date date=relationship.endDate includeTime=true relative=false stripHtml=true />">
      ...
      <#if relationshipsToDisplay?has_content && manageableRelationships?has_content>
        <p>
          ...
          <#else>
            ...
            <span tabindex="0" role="button" class="btn btn-default disabled use-tooltip" title="${tooltipTitle}" data-placement="top">
						Schedule meeting
					</span>
          </#if>
