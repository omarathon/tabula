  ...
  <#macro pagination currentPage totalResults resultsPerPage>
    ...
    <nav class="pull-right" style="margin-top: 0;">
      <#if can.do("Department.Reports", department) >
        <a href="<@routes.profiles.exportProfiles department academicYear filterStudentsCommand.serializeFilter />" class="btn btn-sm btn-default"
           style="vertical-align: top;">Export profiles</a>
      </#if>
