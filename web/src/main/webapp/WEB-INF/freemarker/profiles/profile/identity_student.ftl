      ...
      <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-7 col-lg-8">
            ...
            <#if user.sysadmin>
              <span tabindex="0" role="button" class="tabula-tooltip" data-title="This information is only available to sysadmins"><i class="fal fa-user-crown"></i></span>
                  ...
                  <#if canEditMemberNote || canDeletePurgeMemberNote>
                    <div class="pull-right">
                      ...
                      <span class="dropdown">
                            ...
                            <li>
															<a data-toggle="modal" data-target="#note-modal" href="#note-modal" data-url="<@routes.profiles.edit_member_note memberNote />"
                                 class="edit <#if memberNote.deleted>disabled</#if>" title="Edit note">Edit</a>
														</li>
                          </#if>
