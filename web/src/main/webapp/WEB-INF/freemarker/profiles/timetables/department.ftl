    ...
    <div class="pull-right">
      ...
      <#if academicYears?has_content>
        <#list academicYears as academicYear>
          <a class="btn btn-default timetable-download" href="${timetableDownloadRoute(department, academicYear)}"
             data-href="${timetableDownloadRoute(department, academicYear)}">
