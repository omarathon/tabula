    ...
    <@modal.body>
      <@f.form method="post" modelAttribute="command" action="" cssClass="dirty-check-ignore">
        ...
        <div id="extra-options">
          <#if pageAction != "add">
            <div id="notify-remove-agent" class="alert alert-info hide"><strong>${existingAgent.fullName}</strong> will no longer be ${student.firstName}
              's ${relationshipType.agentRole}.
            </div>
          </#if>
