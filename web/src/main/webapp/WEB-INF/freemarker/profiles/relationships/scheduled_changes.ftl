        ...
        <form action="<@routes.profiles.relationship_scheduled_update department relationshipType />" method="post">
            ...
            <#list relationships as relationship>
              ...
              <tr>
                <td>
                  ...
                  <divtabindex="0" class="use-tooltip" data-html="true" data-container="body"
          ...
          <#if can.do_with_selector('Profiles.StudentRelationship.Manage', department, relationshipType)>
            <#assign apply_popover>
              ...
              <button type="button" class="btn btn-primary apply-scheduled-change" name="action"
                      value="${UpdateScheduledStudentRelationshipChangesControllerActions.Apply}">Apply selected changes
              </button>
            </#assign>
            <#assign cancel_popover>
              ...
              <button type="button" class="btn btn-danger cancel-scheduled-change" name="action"
                      value="${UpdateScheduledStudentRelationshipChangesControllerActions.Cancel}">Cancel selected changes
              </button>
            </#assign>
            <p>
              <button
