  ...
  <#else>
    ...
    <#if command.emptyAdditionalEntities?has_content>
      <div class="alert alert-info">
        ...
        <#else>
          <p>${command.emptyAdditionalEntities?size} ${relationshipType.agentRole}s have no ${relationshipType.studentRole}s, so will be removed from the list
            of ${relationshipType.agentRole}s:</p>
          <ul>
