<#escape x as x?html>
  ...
  <#if fromIndex>
    <#assign helpText>
      <p>Use <a href="http://lucene.apache.org/core/4_0_0/queryparser/org/apache/lucene/queryparser/classic/package-summary.html#Terms">Lucene query syntax</a>
      ...
      <dl>
        <dt class="muted">assignment</dt>
        <dd class="muted">Database GUID</dd>
        <dt>department</dt>
        <dd>Two letter code</dd>
        <dt>eventDate</dt>
        <dd>Flaky. Should be YYYY-MM-DD. Ish.</dd>
        <dt class="muted">eventId</dt>
        <dd class="muted">Database GUID</dd>
        <dt>eventType</dt>
        <dd>CamelCasedFormat</dd>
        <dt class="muted">feedback</dt>
        <dd class="muted">Database GUID</dd>
        <dt class="muted">id</dt>
        <dd class="muted">Mystery numeric value</dd>
        <dt>masqueradeUserId</dt>
        <dd>ITS usercode</dd>
        <dt class="muted">module</dt>
        <dd class="muted">Database GUID</dd>
        <dt class="muted">studentId</dt>
        <dd class="muted">Uni number. Few useful entries.</dd>
        <dt class="muted">students</dt>
        <dd class="muted">Uni number. Few useful entries.</dd>
        <dt class="muted">submission</dt>
        <dd class="muted">Database GUID</dd>
        <dt>submissionIsNoteworthy</dt>
        <dd>true or null, obviously</dd>
        <dt>userId</dt>
        <dd>ITS usercode</dd>
      </dl>
    </#assign>
        ...
        <td>
          <#if fromIndex && item.parsedData??>
            ...
            <#list ['department','module','assignment','feedback','submission','studentId'] as key>
              <#if j[key]??>
                <div><a href="?query=${key}:${j[key]}">${key}: ${j[key]}</a></div></#if>
            </#list>
