      ...
      <div class="col-md-6">
        <#assign popover>
          ...
          <p>The User Access Manager role can view all data in Tabula and assign all levels of permissions to staff in the department.
            This includes assigning the role of Senior Tutor/Supervisor. User Access Managers can assign Departmental Administrators as well as nominate other
            User Access Managers.</p>
        </#assign>

        <h3 class="permissionTitle">Departmental User Access
          Manager <@fmt.help_popover id="uam" title="Departmental admins" content="${popover}" html=true /></h3>
