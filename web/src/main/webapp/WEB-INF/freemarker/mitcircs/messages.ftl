            ...
            <#if !studentView && !message.studentSent>
              <#if message.unreadByStudent>
                <div class="message-thread__body__message__read-indicator message-thread__body__message__read-indicator--unread">
                  <i tabindex="0" title="Message sent" class="fal fa-check use-tooltip"></i>
                </div>
              <#else>
                <div class="message-thread__body__message__read-indicator message-thread__body__message__read-indicator--read">
                  <i tabindex="0" title="Message read" class="fal fa-check-double use-tooltip"></i>
                </div>
              </#if>
            </#if>
          </div>
            ...
            <div class="message-thread__footer__fields">
              ...
              <#if !studentView>
                <label class="btn btn-primary message-thread__footer__fields__btn">
                  <i tabindex="0" class="fal fa-fw fa-paste fa-lg use-tooltip" data-container="body" data-toggle="modal" data-target="#messageTemplates" title="Message templates" aria-label="Message templates"></i>
                </label>
              ...
              <label class="btn btn-primary message-thread__footer__fields__btn">
                ...
                <i tabindex="0" class="fal fa-fw fa-paperclip fa-lg use-tooltip" data-container="body" title="Attach files" aria-label="Attach files"></i>
              </label>
