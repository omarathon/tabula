    ...
    <#if question?has_content>
      <legend>
        ...
        <#if helpPopover?has_content>
          <a tabindex="0" role="button" class="help-popover use-popover tabulaPopover-init" id="popover-evidence" data-html="true" data-placement="left" data-content="${helpPopover}" data-container="body" aria-label="Help" data-original-title="" title="">
