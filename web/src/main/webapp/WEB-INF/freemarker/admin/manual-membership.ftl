<#escape x as x?html>
  ...
  <p>
    This page shows a list of all assignments and small group sets in ${academicYear} that have manually added students. It is important that SITS holds up to
    date information
