<#escape x as x?html>
  ...
  <p>
    ...
    <#else>
      <span tabindex="0" role="button" class="btn btn-primary disabled use-tooltip" data-title="You do not have permission to manage Syllabus+ locations">Add location</span>
    </#if>
  </p>
    ...
    <#list locations as location>
      <tr>
        ...
        <td class="text-right">
          ...
          <#else>
            <span tabindex="0" role="button" class="btn btn-default btn-xs disabled use-tooltip" data-title="You do not have permission to manage Syllabus+ locations">Edit</span>
            <span tabindex="0" role="button" class="btn btn-danger btn-xs disabled use-tooltip" data-title="You do not have permission to manage Syllabus+ locations">Delete</span>
          </#if>
        </td>
      </tr>
    </#list>
