      ...
      <table class="table table-striped permission-list">
        ...
        <#list roleInfo.overrides as override>
          ...
          <tr>
            ...
            <td class="actions">
              <a class="btn btn-xs btn-danger" data-remote="false" href="<@routes.admin.deletecustomroleoverride override />" data-toggle="modal"
                 data-target="#custom-roles-modal">Delete</a>
            </td>
          </tr>
        </#list>
        </tbody>
