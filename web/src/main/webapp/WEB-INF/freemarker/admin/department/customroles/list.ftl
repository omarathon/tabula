        ...
        <tr>
          ...
          <td>
            ...
            <a class="btn btn-default btn-xs"
               href="<@routes.admin.customroleoverrides customRoleDefinition />">+<@fmt.p customRoleDefinition.overrides?size "override"/></a>
          </td>
          <td>
            <a class="btn btn-default btn-xs" href="<@routes.admin.editcustomrole customRoleDefinition />">Modify</a>
            <a class="btn btn-xs btn-danger<#if !canDelete> use-tooltip disabled</#if>" data-remote="false"
               href="<@routes.admin.deletecustomrole customRoleDefinition />" data-toggle="modal"
               data-target="#custom-roles-modal"<#if !canDelete> title="You can't delete this custom role as it is in use by <@fmt.p info.grantedRoles "granted role" /> and <@fmt.p info.derivedRoles "derived role definition" />."</#if>>Delete</a>
          </td>
        </tr>
      </#list>
      </tbody>
