    ...
    <div class="striped-section collapsible checkbox-toggle <#if command.smallGroupEventAttendanceReminderEnabled>expanded</#if>">
      ...
      <div class="striped-section-contents">
        <div class="item-info row">
          ...
          <div class="col-md-6">
            <p>Send to all selected groups or only to the first group with someone in it (e.g. Module Managers will only be notified if an event has no
              tutor).</p>
            <@bs3form.radio>
        ...
        <div class="item-info row">
          ...
          <div class="col-md-6">
            <p>Send to all selected groups or only to the first group with someone in it (e.g. Departmental Administrators will only be notified if there are no
              Module Managers for that module).</p>
            <@bs3form.radio>
