          ...
          <div class="striped-section" data-name="${module_anchor(module)}">
            <div class="clearfix">
              <div class="btn-group section-manage-button">
                ...
                <#else>
                  <a class="btn btn-default dropdown-toggle disabled" title="You do not have permission to manage this module"> Manage <span
                            class="caret"></span></a>
                </#if>
              </div>
          ...
          <div class="striped-section" data-name="${route_anchor(route)}">
            <div class="clearfix">
              <div class="btn-group section-manage-button">
                ...
                <#else>
                  <a class="btn btn-default dropdown-toggle disabled" title="You do not have permission to manage this route"> Manage <span
                            class="caret"></span></a>
                </#if>
              </div>
