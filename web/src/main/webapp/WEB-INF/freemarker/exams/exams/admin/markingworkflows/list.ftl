        ...
        <tr>
          ...
          <td>
            ...
            <#if usedInAssignments || usedInExams>
              ...
              <span tabindex="0" class="btn btn-xs btn-danger use-tooltip disabled" title="${title}">
								<a class="btn-danger disabled">Delete</a>
							</span>
            <#else>
              <a class="btn btn-xs btn-danger use-tooltip ajax-modal" href="<@routes.exams.markingWorkflowDelete department markingWorkflow />"
                 data-target="#marking-workflow-modal">Delete</a>
            </#if>
