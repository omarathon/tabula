  ...
  <#if department??>
    ...
    <div class="btn-toolbar dept-toolbar">
      <#if !modules?has_content && department.children?has_content>
        <div tabindex="0" class="use-tooltip btn btn-default disabled" title="This department doesn't directly contain any modules. Check subdepartments.">
      ...
      <#if modules?has_content && !expand_by_default>
        <div class="btn-group dept-show">
          <a class="btn btn-default use-tooltip" href="#" data-container="body" title="Modules with no exams are hidden. Click to show all modules."
             data-title-show="Modules with no exams are hidden. Click to show all modules."
             data-title-hide="Modules with no exams are shown. Click to hide them">
            Show
          </a>
        </div>
      </#if>
