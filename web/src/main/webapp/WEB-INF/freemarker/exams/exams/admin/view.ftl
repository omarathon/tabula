...
<#escape x as x?html>
  ...
  <div class="btn-toolbar">
    ...
    <#else>
      <span tabindex="0" role="button" class="use-tooltip btn btn-default disabled" data-container="body" title="Marking workflow is not enabled for this exam"><a
    ...
    <#else>
      <span tabindex="0" role="button" class="use-tooltip btn btn-default disabled" data-container="body" title="This exam has already been released for marking"><a
    ...
    <div class="btn-group">
      ...
      <ul class="dropdown-menu">
        <li>
          <a class="long-running form-post include-filter" title="Export exam info as XLSX, for advanced users."
             href="<@routes.exams.exportExcel module exam />">Excel</a>
        </li>
        <li>
          <a class="long-running form-post include-filter" title="Export exam info as CSV, for advanced users." href="<@routes.exams.exportCSV module exam />">Text
            (CSV)</a>
        </li>
        <li>
          <a class="long-running form-post include-filter" title="Export exam info as XML, for advanced users." href="<@routes.exams.exportXML module exam />">Text
            (XML)</a>
        </li>
      </ul>
    </div>
    ...
    <#list students as student>
      ...
      <tr>
        ...
        <#if hasFeedback>
            ...
            <td>
              <#if sitsStatus.status.code == "failed">
                <a href="<@routes.exams.checkSitsUpload feedback />" target="_blank" style="text-decoration: none;">
									<span tabindex="0" role="button" class="label label-danger use-tooltip" title="There was a problem uploading to SITS. Click to try and diagnose the problem.">
          ...
          <#else>
            <td><span class="label label-default">Upload not queued</span></td>
            <td></td>
            <td></td>
            <td></td>
          </#if>
