...
<#escape x as x?html>
  ...
  <#if noFeedbackStudentInfo?size gt 0>
    <p><@fmt.p noFeedbackStudentInfo?size "student does" "students do" /> not have marks you can adjust. You can only adjust marks once marking is
      completed.</p>
      ...
      <#list noFeedbackStudentInfo as info>
        <tr>
          ...
          <td class="student-col">
            <h6>${info.student.lastName}
              &nbsp;<#if info.student.warwickId??><@pl.profile_link info.student.warwickId /><#else><@pl.profile_link info.student.userId /></#if></h6>
          </td>
          <td>
