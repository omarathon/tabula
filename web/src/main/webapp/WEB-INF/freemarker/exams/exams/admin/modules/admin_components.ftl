...
<#escape x as x?html>
  ...
  <#macro admin_section module expand_by_default=true>
    ...
    <div id="${module_anchor(module)}"
         class="module-info striped-section<#if exams?has_content> collapsible<#if expand_by_default> expanded</#if></#if><#if !expand_by_default && !exams?has_content> empty</#if>"
          ...
          <div class="col-md-8">
            ...
            <#else>
              <a href="<@routes.exams.viewExam exam />">
							<span tabindex="0" role="button" class="use-tooltip" title="View all students and feedback">
