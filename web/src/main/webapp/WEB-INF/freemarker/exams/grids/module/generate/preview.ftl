              ...
              <#list entities as entity>
                ...
                <#if mr.studentCourseDetails??>
                  ...
                  <tr class="student <#if entity_index%2 == 1>odd</#if>">
                    ...
                    <td> ${scd.scjCode}</td>
                    <td><span tabindex="0" role="button" class="tabula-tooltip" data-title="${scd.course.shortName!""}">${scd.course.code}</span></td>
                    <td><span tabindex="0" role="button" class="tabula-tooltip" data-title="${scd.currentRoute.name!""}">${scd.currentRoute.code?upper_case}</span></td>
                    ...
                    <#list componentInfo as component>
                      ...
                      <#if mapGet(assessmentComponentMap, groupAndSequenceAndOccurrence)??>
                        ...
                        <td>
                          ...
                          <#else>
                            <span tabindex="0" role="button" class="exam-grid-actual-mark tabula-tooltip" data-title="No mark set">X</span>
                          </#if>
                        </td>
                        <td>
                          ...
                          <#else>
                            <span tabindex="0" role="button" class="exam-grid-actual-mark tabula-tooltip" data-title="No grade set">X</span>
                          </#if>
                        </td>
                      <#else>
                        <td></td>
                    ...
                    <td>
                      ...
                      <#else>
                        <span tabindex="0" role="button" class="exam-grid-actual-mark tabula-tooltip" data-title="No marks set">X</span>
                      </#if>
                    </td>
                    <td>
                      <#if mr.agreedGrade??>
