...
<#escape x as x?html>
  ...
  <form action="<@routes.exams.generateGridOptions department academicYear />" class="dirty-check grid-options" method="post">
    ...
    <h3>Listed CATS
      breakdowns <@fmt.help_popover id="listedcatsbreakdowns" content="CATS totals across all modules that scored above / below given thresholds. Only modules listed in the diet are included. Unusual options are ignored." /></h3>
