        ...
        <#list assessmentComponents as info>
          ...
          <tr>
                ...
                <#list info.components as component>
                  <tr>
                    <td>
                      ...
                      <#else>
                        <span class="exam-grid-actual-mark tabula-tooltip" data-title="No marks set for Assessment component">X</span>
                      </#if>
                    </td>
                  </tr>
                </#list>
                ...
                <#list info.components as component>
                  <tr>
                    <td>
                      ...
                      <#else>
                        <span class="exam-grid-actual-mark tabula-tooltip" data-title="No grade set for Assessment component">X</span>
                      </#if>
                    </td>
                  </tr>
                </#list>
            ...
            <td class="assessment_details_col assessment_details_col1">
              ...
              <#else>
                <span class="exam-grid-actual-mark tabula-tooltip" data-title="No marks set for Module registration">X</span>
              </#if>
            </td>
            <td class="assessment_details_col assessment_details_col1">
              <#if mr.agreedGrade??>
              ...
              <#elseif mr.actualGrade??>
                ${mr.actualGrade}
              <#else>
                <span class="exam-grid-actual-mark tabula-tooltip" data-title="No grade set for Module registration">X</span>
              </#if>
            </td>
          </tr>
        </#list>
