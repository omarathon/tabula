    ...
    <div class="tab-pane " id="webform">
      ...
      <@f.form id="marks-web-form" method="post" enctype="multipart/form-data" action="${formUrl}" modelAttribute="command">
        <div class="fix-area">
            ...
            <#if marksToDisplay??>
              <#list marksToDisplay as markItem>
                <div class="mark-row row form-group clearfix">
                  <div class="col-md-3">
                    <input class="universityId form-control" value="${markItem.universityId}" name="marks[${markItem_index}].studentId" type="text"
                           readonly="readonly" />
                  </div>
                  <div class="col-md-2">
                    <div class="input-group">
          ...
          <p>
            <button class="add-additional-marks btn btn-default" type="button">Add</button>
          </p>
