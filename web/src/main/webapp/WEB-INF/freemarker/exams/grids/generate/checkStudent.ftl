...
<#else>
	<#macro pass><div class="alert alert-success"><i class="fa fa-check"></i>&nbsp;&nbsp;<#nested /></div></#macro>
	<#macro fail><#assign errror=true /><div class="alert alert-danger"><i class="fa fa-times"></i>&nbsp;&nbsp;<#nested /></div></#macro>
	<#assign errror=false />
