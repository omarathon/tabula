          ...
          <div class="row item-info">
            <div class="col-md-9">
              <div class="pull-right">
                ...
                <a class="btn btn-danger btn-sm<#if scheme.hasRecordedCheckpoints> disabled use-tooltip</#if>"
                   <#if scheme.hasRecordedCheckpoints>title="This scheme cannot be removed as it has attendance marks against some of its points."</#if>
                   href="<@routes.attendance.manageDeleteScheme command.department academicYear scheme/>">Delete</a>
              </div>
