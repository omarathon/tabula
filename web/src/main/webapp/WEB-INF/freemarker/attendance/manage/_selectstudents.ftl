                    ...
                    <li class="checkbox check-list-item" data-natural-sort="${route_index}">
                      <label class="checkbox"><#compress>
                          <input type="checkbox" name="${status.expression}" value="${route.code}"
                                 data-short-value="${route.code?upper_case}" ${contains_by_code(findCommand.routes, route)?string('checked','')}>
    ...
    <div class="striped-section-contents">
      <div class="item-info">
        <p style="margin-bottom: 1em;">
          <input style="margin-right: 8px;" class="btn btn-default" type="submit" name="${ManageSchemeMappingParameters.manuallyAddForm}"
