<#escape x as x?html>
  ...
  <div class="fix-area">
    ...
    <form action="<@routes.attendance.manageAddPointsCopy command.department command.academicYear />" method="post">
      ...
      <div>
        <div class="alert alert-info">
          <p>The following points relate to submitting old assignments in ${year}. These points will be copied and changed to 'submission of any module or
            assignment'. You can edit these points after you copy them.</p>
