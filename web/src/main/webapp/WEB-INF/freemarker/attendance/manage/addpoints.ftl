    ...
    <form method="POST">
      ...
      <#else>
        <div class="alert alert-info">
          ...
          <a class="btn btn-default" href="<@routes.attendance.manageEditPoints command.department command.academicYear schemesParam />">Edit points</a>
        </div>
      </#if>
      ...
      <p>
        <button type="button" class="btn btn-default add-blank-point"
                data-href="<@routes.attendance.manageAddPointsBlank command.department command.academicYear/>">Add a point
        </button>
        <button type="button" class="btn btn-default copy-points" data-href="<@routes.attendance.manageAddPointsCopy command.department command.academicYear/>">
          Copy points
        </button>
        <button type="button" class="btn btn-default use-template"
                data-href="<@routes.attendance.manageAddPointsTemplate command.department command.academicYear/>">Use template
        </button>
