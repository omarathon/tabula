<#escape x as x?html>
  ...
  <div class="add-points-to-schemes fix-area">
    ...
    <p class="progress-arrows">
      <span tabindex="0" role="button" class="arrow-right use-tooltip" title="Edit properties"><a
                href="<@routes.attendance.manageEditScheme findCommand.department findCommand.academicYear scheme />">Properties</a></span>
      <span tabindex="0" role="button" class="arrow-right arrow-left use-tooltip" title="Edit students"><a
