<#escape x as x?html>
  ...
  <div class="add-points-to-schemes fix-area">
    ...
    <p class="progress-arrows">
      <span tabindex="0" role="button" class="arrow-right use-tooltip" title="Edit properties">Properties</span>
      <span tabindex="0" role="button" class="arrow-right arrow-left use-tooltip" title="Edit students"><a href="<@routes.attendance.manageAddStudents scheme />">Students</a></span>
    ...
    <@f.form method="post">
      ...
      <button type="button" class="btn btn-default add-blank-point"
              data-href="<@routes.attendance.manageAddPointsBlank findCommand.department findCommand.academicYear/>">Add a point
      </button>
      <button type="button" class="btn btn-default copy-points"
              data-href="<@routes.attendance.manageAddPointsCopy findCommand.department findCommand.academicYear/>">Copy points
      </button>
