  ...
  <#else>
    ...
    <div class="monitoring-points-profile attendance-notes striped-section collapsible expanded">
      ...
      <div class="striped-section-contents">
            ...
            <div class="col-md-12 form-inline">
              <div class="form-group">
                ...
                <#list allCheckpointStates as state>
                  <label class="checkbox-inline"><input type="checkbox" class="collection-checkbox" name="checkpointState" value="${state.dbValue}"
                                                        checked />${state.description}</label>
                </#list>
              </div>
            </div>
          </div>
        ...
        <#else>
          <div class="row item-info">
            <div class="col-md-12"><em>There are no notes.</em></div>
          </div>
        </#if>
      </div>
    </div>
