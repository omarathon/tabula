  ...
  <#escape x as x?html>
    ...
    <@f.form action="/app/tell-us" method="post" modelAttribute="appCommentCommand" id="app-comment-form">
      ...
      <p>
        ...
        If you are looking for instructions on how to use Tabula, you might like to look at <a class="btn btn-primary"
                                                                                               href="http://warwick.ac.uk/tabula/manual/" target="_blank">the
          Tabula manual</a>
      </p>
