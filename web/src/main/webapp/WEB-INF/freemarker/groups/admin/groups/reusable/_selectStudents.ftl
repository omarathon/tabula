      ...
      <div class="striped-section-contents">
        <div class="item-info">
          ...
          <div class="student-filter btn-group-group well well-sm">
            ...
            <div class="btn-group">
              <button disabled class="btn btn-xs btn-primary search" type="submit" name="${ManageDepartmentSmallGroupsMappingParameters.findStudents}"
                      value="true">Find
              </button>
            </div>
      ...
      <div class="striped-section-contents">
        <div class="item-info">
          <p style="margin-bottom: 1em;">
            <input style="margin-right: 8px;" class="btn btn-default" type="submit" name="${ManageDepartmentSmallGroupsMappingParameters.manuallyAddForm}"
