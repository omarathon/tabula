    ...
    <@bs3form.form_group>
      <div class="row flush">
        <div class="col-md-4 col-md-offset-4">
          ...
          &nbsp;
          Set group numbers
          <a tabindex="0" role="button" class="use-popover" data-trigger="click focus" data-html="true" data-content="Leave the max group size field empty for no limit" data-original-title="" title="">
      ...
      <@bs3form.form_group>
        <div class="row ${cssClass}">
          ...
          <#if !no_remove_button>
            ...
            <#if !is_new>
              <p class="help-block col-md-12 hidden">
                <small>
