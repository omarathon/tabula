  ...
  <div class="tabbable">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="allocategroups-tab1">
        ...
        <div class="fix-area">
          <@f.form method="post" action="${submitUrl}" modelAttribute="command" cssClass="allocateStudentsToGroupsCommand">
                      ...
                      <div class="drag-target well clearfix group-${group.id}">
                        <div class="group-header">
                          ...
                          <div>
                            ...
                            <a id="show-list-${group.id}" class="show-list" title="View students" aria-label="View students" data-container=".group-${group.id}"
                               data-title="${popoverHeader}" data-placement="left"><i class="fa fa-pencil-square-o"></i></a>
                          </div>
                        </div>
      ...
      <div class="tab-pane" id="allocategroups-tab2">
        ...
        <@f.form method="post" enctype="multipart/form-data" action="${submitUrl}" modelAttribute="command">

          <p>You can allocate students to groups using a spreadsheet.</p>

          <ol>
            <li><strong><a href="<@routes.groups.crossmodulegroupstemplate smallGroupSet />">Download a template spreadsheet</a></strong>. This will be
              prefilled with the names and University ID numbers of students you have selected to be in ${smallGroupSet.name}. In Excel you may need to <a
