...
<#escape x as x?html>
  ...
  <#if updatedOccurrence??>
    <div class="alert alert-info">
      ...
      in
      <strong><@fmt.singleWeekFormat week=updatedOccurrence.week academicYear=updatedOccurrence.event.group.groupSet.academicYear dept=updatedOccurrence.event.group.groupSet.module.adminDepartment /></strong>
      has been recorded.
    </div>
  </#if>
