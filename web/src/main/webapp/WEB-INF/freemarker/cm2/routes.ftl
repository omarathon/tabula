...
<#macro feedbackSingleFileDownload feedback attachment><@_u page="/admin/assignments/${feedback.assignment.id}/feedback/download/${feedback.id}/attachment/${attachment.name?url}" /></#macro>
