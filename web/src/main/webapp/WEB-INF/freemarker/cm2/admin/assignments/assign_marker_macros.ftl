...
<#macro allocateStudents assignment role stages markers unassigned assigned stageAllocation>
  ...
  <p>Drag students onto a ${role} to allocate them. Select multiple students by dragging a box around them. You can also hold the <kbd
            class="keyboard-control-key">Ctrl</kbd> key and drag to add to a selection.</p>
            ...
            <div class="drag-target well clearfix ${safeRole}-${marker.userId}">
              <div class="group-header">
                ...
                <div>
                  ...
                  <a id="show-list-${safeRole}-${marker.userId}" class="show-list" title="View students" aria-label="View students"
                     data-container=".${safeRole}-${marker.userId}" data-title="${popoverHeader}" data-placement="left"><i
