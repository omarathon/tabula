<#escape x as x?html>
  ...
  <div class="fix-area">
    ...
    <@f.form method="post" action=actionUrl enctype="multipart/form-data" cssClass="dirty-check" modelAttribute="assignMarkersBySpreadsheetCommand">
      ...
      <ol>
        ...
        <li>In the <strong>Marker name</strong> column, choose the marker you wish to allocate from the drop-down menu.
          When you choose a marker, the <strong>Marker usercode</strong> column updates automatically.
        </li>
