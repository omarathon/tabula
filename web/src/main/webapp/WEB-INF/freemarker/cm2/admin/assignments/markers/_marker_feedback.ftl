<div class="marking-and-feedback"<#if command.stage.populateWithPreviousFeedback && !command.currentMarkerFeedback.hasBeenModified> style="display:none;"</#if>>
	...
	<@f.form method="post" enctype="multipart/form-data" commandName="command" studentid="${command.student.userId}" action=actionUrl cssClass="dirty-check double-submit-protection ajax-form">
