<#escape x as x?html>
  <@bs3form.labelled_form_group path="" labelText="Set submission options">
    <@bs3form.checkbox path="collectSubmissions">
      <@f.checkbox path="collectSubmissions" id="collectSubmissions" data\-selector=".collect-submission-options" /> Collect submissions
    </@bs3form.checkbox>
    <span class="help-block">Select this option to enable students to submit coursework for this assignment.</span>
  </@bs3form.labelled_form_group>

  <div class="collect-submission-options">
  ...
  <script type="text/javascript" nonce="${nonce()}">
    jQuery(function ($) {
      $('#collectSubmissions').radioControlled({ mode: 'disabled' });
    });
  </script>
</#escape>
