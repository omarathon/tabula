...
<div class="well">
  ...
  <div class="labels">
    <#if submission.late>
      <span tabindex="0" role="button" class="label label-danger use-tooltip" title="<@components.lateness submission />" data-container="body">Late</span>
    <#elseif  submission.authorisedLate>
      <span tabindex="0" role="button" class="label label-info use-tooltip" title="<@components.lateness submission />" data-container="body">Within Extension</span>
    </#if>

    <#if submission.suspectPlagiarised>
      <span tabindex="0" role="button" class="label label-danger use-tooltip" title="Suspected of being plagiarised" data-container="body">Plagiarism suspected</span>
    <#elseif submission.investigationCompleted>
      <span tabindex="0" role="button" class="label label-info use-tooltip" title="No evidence of plagiarism was found" data-container="body">Plagiarism investigation completed</span>
    </#if>
