...
<#if has_assignments || has_historical_items || user.student || user.PGR>
  <div class="header-with-tooltip" id="your-assignments">
    <#if ajax>
    <h4><#else><h2 class="section"></#if>
        <#if isSelf>My<#else>${student.firstName}'s</#if> assignments
      <#if ajax></h4>
    <#else></h2></#if>
    <#if isSelf>
      <span tabindex="0" role="button" class="use-tooltip" data-toggle="tooltip" data-html="true" data-placement="bottom"
        ...
        <div class="item-info clearfix marked">
          <div class="row-fluid">
            ...
            <div class="span5">
              ...
              <#elseif isFormative>
                <span tabindex="0" role="button" class="label use-tooltip"
