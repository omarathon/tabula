...
<#macro row graph>
  ...
  <tr class="item-container" data-contentid="${markingId(u)}" data-markingurl="${onlineMarkingUrls[u.userId]}">
    ...
    <#if department.showStudentName>
      ...
      <td class="student-col toggle-cell"><h6>${u.lastName}
          &nbsp;<#if u.warwickId??><@pl.profile_link u.warwickId /><#else><@pl.profile_link u.userId /></#if></h6></td>
    <#else>
  ...
  <#if showMarkingCompleted>
    <div class="btn-toolbar">
      <div class="btn-group-group">
        ...
        <div class="btn-group">
          <a id="marking-complete-button" data-container="body" class="must-have-selected btn use-tooltip form-post"
             href="<@routes.coursework.markingCompleted assignment marker />" title=""
             data-original-title="Finalise marks and feedback. Changes cannot be made to marks or feedback files after this point.">
            <i class="icon-ok"></i>
            Marking completed
          </a>
        </div>
