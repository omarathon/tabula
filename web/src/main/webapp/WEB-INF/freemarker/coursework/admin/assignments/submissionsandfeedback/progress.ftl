    ...
    <table class="coursework-progress-table students table table-bordered table-striped tabula-greenLight sticky-table-headers ">
      ...
      <#if students?size gt 0>
        ...
        <#macro action actionCode student>
          <#local studentDetails><span
            data-profile="<@studentIdentifier student.user />"><#if department.showStudentName>${student.user.fullName}<#else><@studentIdentifier student.user /></#if></span></#local>
              ...
              <div class="stage-group clearfix">
                ...
                <div class="labels">
                  <#if submission?? && submission.suspectPlagiarised>
                    <i tabindex="0" class="icon-exclamation-sign use-tooltip" title="Suspected of being plagiarised" data-container="body"></i>
                  </#if>
                </div>
                      ...
                      <#if enhancedFeedback.feedbackForSits??>
                        ...
                        <#if feedbackSitsStatus.code == "failed">
                          <a href="<@routes.coursework.checkSitsUpload feedback />" target="_blank">
														<span tabindex="0" style="cursor: pointer;" class="label label-important use-tooltip"
                                  title="There was a problem uploading to SITS. Click to try and diagnose the problem.">
															${feedbackSitsStatus.description}
														</span><#--
													--></a>
                        <#elseif sitsWarning>
                          <span tabindex="0" class="label label-important use-tooltip"
                ...
                <@stage student.stages['AddFeedback']><#compress>
                  <#if feedback?? && (feedback.hasAttachments || feedback.hasOnlineFeedback)>: <#compress>
                    ...
                    <#if attachments?size gt 0>
                      ...
                      <a class="long-running"
                         href="<@routes.coursework.adminFeedbackZip assignment student.coursework.enhancedFeedback.feedback attachmentExtension />"><#compress>
        ...
        <#macro row student>
          <tr data-contentid="<@studentIdentifier student.user />"
              class="itemContainer<#if !student.coursework.enhancedSubmission??> awaiting-submission</#if>"<#if student.coursework.enhancedSubmission?? && student.coursework.enhancedSubmission.submission.suspectPlagiarised> data-plagiarised="true"</#if>>
            ...
            <#if department.showStudentName>
              ...
              <td class="student-col toggle-cell">
                <h6 data-profile="<@studentIdentifier student.user />">
                  ...
                  &nbsp;<#if student.user.warwickId??><@pl.profile_link student.user.warwickId /><#else><@pl.profile_link student.user.userId /></#if>
                </h6>
              </td>
            <#else>
            ...
            <td class="progress-col content-cell toggle-cell">
              ...
              <dl tabindex="0" class="progress progress-${student.progress.t} use-tooltip" title="${progressTooltip}" style="margin: 0; border-bottom: 0;"
                  data-container="body">
  ...
  <#if students?size gt 0>
    ...
    <script type="text/javascript" nonce="${nonce()}">
      (function ($) {
        ...
        $('.coursework-progress-table').each(function () {
          $(this).expandingTable({tableSorterOptions: options});
        });
