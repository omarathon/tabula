          ...
          <#list bulkFeedbackTemplateCommand.department.feedbackTemplates as template>
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-mini" href="#feedback-template-model" data-toggle="modal"
                   data-url="<@routes.coursework.feedbacktemplateedit department=department feedbacktemplate=template />">
                  <i class="icon-pencil"></i> Edit
                </a>
                <#if !template.hasAssignments>
                  <a class="btn btn-mini btn-danger" href="#feedback-template-model" data-toggle="modal"
                     data-url="<@routes.coursework.feedbacktemplatedelete department=department feedbacktemplate=template />">
