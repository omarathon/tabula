  ...
  <div class="btn-toolbar">
    <div class="pull-right view-selector">
      <form class="form-inline">
        ...
        <label class="radio">
          <input type="radio" name="view" value="summary" data-href="<@routes.coursework.assignmentsubmissionsandfeedbacksummary assignment />"
                 <#if currentView == 'summary'>checked="checked"</#if> />
          Summary
        </label>
        <label class="radio">
          <input type="radio" name="view" value="table" data-href="<@routes.coursework.assignmentsubmissionsandfeedbacktable assignment />"
    ...
    <div class="btn-group-group">
      ...
      <#else>
        <div class="btn-group">
          <a tabindex="0" role="button" class="btn dropdown-toggle disabled use-tooltip" title="This assignment does not collect submissions" data-container="body">
            Submission
            <span class="caret"></span>
          </a>
        </div>
      ...
      <#elseif assignment.collectSubmissions>
        <div class="btn-group">
          <a tabindex="0" role="button" class="btn dropdown-toggle disabled use-tooltip" title="Your department does not use plagiarism detection in Tabula" data-container="body">
            Plagiarism
            <span class="caret"></span>
          </a>
        </div>
      ...
      <#if assignment.collectSubmissions && features.markingWorkflows>
        ...
        <#else>
          <div class="btn-group">
            <a tabindex="0" role="button" class="btn dropdown-toggle disabled use-tooltip"
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          ...
          <#else>
            <li class="disabled"><a tabindex="0" class="use-tooltip" data-container="body" title="You cannot adjust marks on an assignment that does not collect marks"><i
                        class="icon-sort icon-fixed-width"></i> Adjustments</a></li>
          </#if>
          ...
          <#else>
            <li class="disabled"><a tabindex="0" class="use-tooltip" data-container="body" title="No current feedback to publish, or the assignment is not yet closed."><i
                        class="icon-share icon-fixed-width"></i> Publish feedback</a></li>
          </#if>
          <li class="must-have-selected">
    ...
    <div class="btn-group">
      ...
      <ul class="dropdown-menu">
        <li>
          <a class="long-running form-post include-filter" title="Export submissions info as XLSX, for advanced users."
             href="<@routes.coursework.assignmentExportExcel assignment />">Excel</a>
        </li>
        <li>
          <a class="long-running form-post include-filter" title="Export submissions info as CSV, for advanced users."
             href="<@routes.coursework.assignmentExportCSV assignment />">Text (CSV)</a>
        </li>
        <li>
          <a class="long-running form-post include-filter" title="Export submissions info as XML, for advanced users."
             href="<@routes.coursework.assignmentExportXML assignment />">Text (XML)</a>
        </li>
      </ul>
    </div>
