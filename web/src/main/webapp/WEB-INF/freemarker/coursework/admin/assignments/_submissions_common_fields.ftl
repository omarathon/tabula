...
<#if features.submissions>
  <fieldset id="submission-options">
    <details <#if ((assignment.collectSubmissions)?? && assignment.collectSubmissions) || collectSubmissions?? && collectSubmissions > open </#if>
            class="submissions">
      ...
      <div>
              ...
              <@form.field>
                ...
                <div class="help-block">
                  ...
                  <#if can.do("Department.ManageExtensionSettings", department)>
                    <a class="btn btn-mini use-tooltip" title="Department extension request settings (opens in a new window/tab)"
                       href="<@routes.coursework.extensionsettings department />" target="_blank">Review</a>
                  <#else>
        ...
        <@form.row>
          ...
          <@form.field>
            ...
            <div class="help-block">
              Enter the file types you would like to allow separated by spaces (e.g. "pdf doc docx"). Press the spacebar individually after each file type. Only
              attachments with the extensions specified will be permitted. Leave this field blank to accept attachments with any extension.
            </div>
          </@form.field>
        </@form.row>
        ...
        <@form.row>
          ...
          <@form.field>
            ...
            <div class="help-block">
              Enter the maximum file size (in Megabytes) for a single uploaded file. If you wish to submit the file(s) to Turnitin each file can be no larger
        ...
        <@form.row path="comment">
          ...
          <@form.field>
            ...
            <div class="help-block">
              You can use Markdown syntax <a target="_blank" href="https://warwick.ac.uk/tabula/manual/cm2/markers/markdown/"><i
                        class="icon-question-sign fa fa-question-circle"></i></a>
            </div>
          </@form.field>
        </@form.row>
