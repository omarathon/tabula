<#escape x as x?html>
  ...
  <@f.form cssClass="submission-form double-submit-protection form-horizontal" method="post" action="${formAction}" modelAttribute="markingUncompletedCommand">
    ...
    <@spring.bind path="markerFeedback">
      ...
      <p>
        <strong>Feedback for <@fmt.p markingUncompletedCommand.markerFeedback?size "submission" /></strong> will be returned to the ${previousStageRole} for
        changes.
      </p>
    ...
    <@form.row>
      ...
      <@form.field>
        <label class="checkbox">
          ...
          I confirm that I would like to return <@fmt.p markerFeedback?size "this student's submission" "these students' submissions" "1" "0" false /> to
          the ${previousStageRole}.
        </label>
      </@form.field>
    </@form.row>
