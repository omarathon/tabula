    ...
    <#if students??>
      ...
      <div class="submission-feedback-list">
        <table class="table table-bordered table-striped table-condensed submission-table">
          ...
          <thead>
          <tr>
            <th class="check-col student">
              <div class="check-all checkbox"><input type="checkbox" class="collection-check-all"></div>
            </th>
              ...
              <td class="submission-status">
                ...
                <#-- Plagiarised -->
                  <#if submission.suspectPlagiarised>
                    <i tabindex="0" class="icon-exclamation-sign use-tooltip" title="Suspected of being plagiarised"></i>
                  <#elseif submission.investigationCompleted>
                    <i tabindex="0" class="icon-ok-sign use-tooltip" title="Plagiarism investigation completed"></i>
                  </#if>
                </#if>
                ...
                <#if student.coursework.enhancedFeedback??>
                  ...
                  <#if attachments?size gt 0>
                    ...
                    <a class="long-running"
                       href="<@routes.coursework.adminFeedbackZip assignment student.coursework.enhancedFeedback.feedback attachmentExtension />">
