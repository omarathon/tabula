  ...
  <@f.form method="post" action="${formAction}" modelAttribute="releaseForMarkingCommand">
    ...
    <#else>
      <div class="alert alert-warning">
        None of the students that you selected can be released for marking. <a href="<@routes.coursework.assignmentsubmissionsandfeedback assignment />">Go back
          to the assignment summary.</a>
      </div>
    </#if>
