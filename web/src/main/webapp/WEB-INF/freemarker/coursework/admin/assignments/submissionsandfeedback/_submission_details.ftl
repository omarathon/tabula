...
<#macro submission_details submission=""><#compress>
  <#if submission?has_content>: <#compress>
    ...
    <#if attachments?size gt 0>
      ...
      <span tabindex="0" role="button" class="date tabula-tooltip" data-title="<@lateness submission />"><#compress>
  ...
  <#if submission?has_content>
    <#if submission.late>
      <#if enhancedExtension?has_content && enhancedExtension.extension.approved>
        <span tabindex="0" role="button" class="label label-important use-tooltip" title="<@extensionLateness enhancedExtension.extension submission/>" data-container="body">Late</span>
      <#else>
        <span tabindex="0" role="button" class="label label-important use-tooltip" title="<@lateness submission />" data-container="body">Late</span>
      </#if>
