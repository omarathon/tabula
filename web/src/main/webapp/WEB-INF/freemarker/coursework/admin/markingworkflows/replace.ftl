  ...
  <div class="fix-area">
    ...
    <@f.form method="post" action="${form_url}" modelAttribute="command" cssClass="form-horizontal">
      ...
      <div class="alert alert-warning">
        ...
        <p>
          <label class="checkbox"><@f.checkbox path="confirm" /> I understand that I need to contact the new marker to inform them that they may need to mark
            submissions.</label>
      ...
      <div class="submit-buttons fix-footer">
        ...
        <a class="btn" href="<@routes.coursework.markingworkflowedit markingWorkflow />">Cancel</a>
      </div>
    </@f.form>
  </div>
</#escape>