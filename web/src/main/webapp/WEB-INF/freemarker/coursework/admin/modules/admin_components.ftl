...
<#escape x as x?html>
  ...
  <#macro admin_section module expand_by_default=true>
    ...
    <div id="${module_anchor(module)}"
         class="module-info striped-section<#if has_assignments || has_archived_assignments> collapsible<#if expand_by_default> expanded</#if></#if><#if !expand_by_default && !has_assignments> empty</#if>"
