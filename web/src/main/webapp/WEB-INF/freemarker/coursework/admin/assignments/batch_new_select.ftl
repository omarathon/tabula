      ...
      <div class="span2">
        ...
        <#elseif step='options'>
          <div id="options-buttons">
            <button class="btn btn-large btn-block use-tooltip" data-container="body" data-action="refresh-select"
                    title="Go back to change your assignment choices, without losing your work so far.">&larr; Back
            </button>
            ...
            <#-- options sets -->
            <a class="btn btn-info btn-block" id="set-options-button" data-target="#set-options-modal"
               href="<@routes.coursework.setupSitsAssignmentsSharedOptions department />">
              Set options&hellip;
            </a>
